...
class InlineObject66(object):
    ...
    openapi_types = {
        'name': 'str',
        'payout_at_expiration': 'bool',
        'payout_at_termination': 'bool'
    }

    attribute_map = {
        'name': 'name',
        'payout_at_expiration': 'payoutAtExpiration',
        'payout_at_termination': 'payoutAtTermination'
    }

    def __init__(self, name=None, payout_at_expiration=None, payout_at_termination=None, local_vars_configuration=None):  # noqa: E501
        """InlineObject66 - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._name = None
        self._payout_at_expiration = None
        self._payout_at_termination = None
        self.discriminator = None

        if name is not None:
            self.name = name
        if payout_at_expiration is not None:
            self.payout_at_expiration = payout_at_expiration
        if payout_at_termination is not None:
            self.payout_at_termination = payout_at_termination

    @property
    def name(self):
        """Gets the name of this InlineObject66.  # noqa: E501

        Supplement type to update  # noqa: E501

        :return: The name of this InlineObject66.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this InlineObject66.

        Supplement type to update  # noqa: E501

        :param name: The name of this InlineObject66.  # noqa: E501
        :type: str
        """
        allowed_values = ["DenmarkSHDage", "DenmarkFritvalg"]  # noqa: E501
    ...
    @property
    def payout_at_expiration(self):
        """Gets the payout_at_expiration of this InlineObject66.  # noqa: E501

        New value for payoutAtExpiration  # noqa: E501

        :return: The payout_at_expiration of this InlineObject66.  # noqa: E501
        :rtype: bool
        """
        return self._payout_at_expiration

    @payout_at_expiration.setter
    def payout_at_expiration(self, payout_at_expiration):
        """Sets the payout_at_expiration of this InlineObject66.

        New value for payoutAtExpiration  # noqa: E501

        :param payout_at_expiration: The payout_at_expiration of this InlineObject66.  # noqa: E501
        :type: bool
        """

        self._payout_at_expiration = payout_at_expiration

    @property
    def payout_at_termination(self):
        """Gets the payout_at_termination of this InlineObject66.  # noqa: E501

        New value for payoutAtTermination  # noqa: E501

        :return: The payout_at_termination of this InlineObject66.  # noqa: E501
        :rtype: bool
        """
        return self._payout_at_termination

    @payout_at_termination.setter
    def payout_at_termination(self, payout_at_termination):
        """Sets the payout_at_termination of this InlineObject66.

        New value for payoutAtTermination  # noqa: E501

        :param payout_at_termination: The payout_at_termination of this InlineObject66.  # noqa: E501
        :type: bool
        """

        self._payout_at_termination = payout_at_termination
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineObject66):
            return False
