...
class EmployeesImportErrors(object):
    ...
    def __init__(self, bad_fields=None, missing_fields=None, local_vars_configuration=None):  # noqa: E501
        """EmployeesImportErrors - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._bad_fields = None
    ...
    @property
    def bad_fields(self):
        """Gets the bad_fields of this EmployeesImportErrors.  # noqa: E501

        List of fields whose data is not valid for an import  # noqa: E501

        :return: The bad_fields of this EmployeesImportErrors.  # noqa: E501
        :rtype: list[str]
        """
        return self._bad_fields

    @bad_fields.setter
    def bad_fields(self, bad_fields):
        """Sets the bad_fields of this EmployeesImportErrors.

        List of fields whose data is not valid for an import  # noqa: E501

        :param bad_fields: The bad_fields of this EmployeesImportErrors.  # noqa: E501
        :type: list[str]
        """
    ...
    def missing_fields(self):
        """Gets the missing_fields of this EmployeesImportErrors.  # noqa: E501

        List of fields that require a value to be imported.  # noqa: E501

        :return: The missing_fields of this EmployeesImportErrors.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def missing_fields(self, missing_fields):
        """Sets the missing_fields of this EmployeesImportErrors.

        List of fields that require a value to be imported.  # noqa: E501

        :param missing_fields: The missing_fields of this EmployeesImportErrors.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EmployeesImportErrors):
            return False
