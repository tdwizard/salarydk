...
class InlineResponse20095(object):
    ...
    @property
    def data(self):
        """Gets the data of this InlineResponse20095.  # noqa: E501


        :return: The data of this InlineResponse20095.  # noqa: E501
        :rtype: list[EmploymentPosition]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this InlineResponse20095.


        :param data: The data of this InlineResponse20095.  # noqa: E501
        :type: list[EmploymentPosition]
        """
