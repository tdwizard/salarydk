...
class InlineObject6(object):
    ...
    openapi_types = {
        'employee_id': 'str',
        'transfers': 'list[V2BalanceTransferLeaveTransfers]'
    }
    ...
    def __init__(self, employee_id=None, transfers=None, local_vars_configuration=None):  # noqa: E501
    ...
    def employee_id(self):
        """Gets the employee_id of this InlineObject6.  # noqa: E501


        :return: The employee_id of this InlineObject6.  # noqa: E501
        :rtype: str
        """
    ...
    def employee_id(self, employee_id):
        """Sets the employee_id of this InlineObject6.


        :param employee_id: The employee_id of this InlineObject6.  # noqa: E501
        :type: str
        """
    ...
    @property
    def transfers(self):
        """Gets the transfers of this InlineObject6.  # noqa: E501

        A list of transfers to make, the transfers are moves not copies, so the from-account will be emptied  # noqa: E501

        :return: The transfers of this InlineObject6.  # noqa: E501
        :rtype: list[V2BalanceTransferLeaveTransfers]
        """
        return self._transfers

    @transfers.setter
    def transfers(self, transfers):
        """Sets the transfers of this InlineObject6.

        A list of transfers to make, the transfers are moves not copies, so the from-account will be emptied  # noqa: E501

        :param transfers: The transfers of this InlineObject6.  # noqa: E501
        :type: list[V2BalanceTransferLeaveTransfers]
        """
