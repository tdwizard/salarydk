...
class InlineObject13(object):
    ...
    """
    openapi_types = {
        'flags': 'list[CompanySettingBoolean]'
    }
    ...
    @property
    def flags(self):
        """Gets the flags of this InlineObject13.  # noqa: E501

        List of boolean settings to be the only ones enabled (all others will be disabled)  # noqa: E501

        :return: The flags of this InlineObject13.  # noqa: E501
    ...
    def flags(self, flags):
        """Sets the flags of this InlineObject13.

        List of boolean settings to be the only ones enabled (all others will be disabled)  # noqa: E501

        :param flags: The flags of this InlineObject13.  # noqa: E501
