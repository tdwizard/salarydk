...
class SalaryDefinition(object):
    ...
    def __init__(self, id=None, quantity=None, rate=None, salary_type_id=None, title=None, type=None, local_vars_configuration=None):  # noqa: E501
        """SalaryDefinition - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this SalaryDefinition.  # noqa: E501

        The ID of the salary entry  # noqa: E501

        :return: The id of this SalaryDefinition.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this SalaryDefinition.

        The ID of the salary entry  # noqa: E501

        :param id: The id of this SalaryDefinition.  # noqa: E501
        :type: str
        """
    ...
    @property
    def quantity(self):
        """Gets the quantity of this SalaryDefinition.  # noqa: E501

        The quantity of the salary entry.  # noqa: E501

        :return: The quantity of this SalaryDefinition.  # noqa: E501
        :rtype: float
        """
    ...
    def quantity(self, quantity):
        """Sets the quantity of this SalaryDefinition.

        The quantity of the salary entry.  # noqa: E501

        :param quantity: The quantity of this SalaryDefinition.  # noqa: E501
        :type: float
        """
    ...
    @property
    def rate(self):
        """Gets the rate of this SalaryDefinition.  # noqa: E501

        The rate of the salary entry.  # noqa: E501

        :return: The rate of this SalaryDefinition.  # noqa: E501
        :rtype: float
        """
        return self._rate
    ...
    @rate.setter
    def rate(self, rate):
        """Sets the rate of this SalaryDefinition.

        The rate of the salary entry.  # noqa: E501

        :param rate: The rate of this SalaryDefinition.  # noqa: E501
        :type: float
        """
    ...
    def salary_type_id(self):
        """Gets the salary_type_id of this SalaryDefinition.  # noqa: E501

        The salary type.  # noqa: E501

        :return: The salary_type_id of this SalaryDefinition.  # noqa: E501
        :rtype: str
        """
    ...
    def salary_type_id(self, salary_type_id):
        """Sets the salary_type_id of this SalaryDefinition.

        The salary type.  # noqa: E501

        :param salary_type_id: The salary_type_id of this SalaryDefinition.  # noqa: E501
        :type: str
        """
    ...
    @property
    def title(self):
        """Gets the title of this SalaryDefinition.  # noqa: E501

        The title of the salary entry. Will be stated on the pay slip.  # noqa: E501

        :return: The title of this SalaryDefinition.  # noqa: E501
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this SalaryDefinition.

        The title of the salary entry. Will be stated on the pay slip.  # noqa: E501

        :param title: The title of this SalaryDefinition.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this SalaryDefinition.  # noqa: E501

        Deprecated. Use salaryTypeID instead. The type of the salary entry.  # noqa: E501

        :return: The type of this SalaryDefinition.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this SalaryDefinition.

        Deprecated. Use salaryTypeID instead. The type of the salary entry.  # noqa: E501

        :param type: The type of this SalaryDefinition.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SalaryDefinition):
            return False
