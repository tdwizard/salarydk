...
class InlineObject5(object):
    ...
    def __init__(self, api_client_id=None, api_client_secret=None, api_key=None, local_vars_configuration=None):  # noqa: E501
    ...
    def api_client_id(self):
        """Gets the api_client_id of this InlineObject5.  # noqa: E501

        Your API client ID  # noqa: E501

        :return: The api_client_id of this InlineObject5.  # noqa: E501
        :rtype: str
        """
    ...
    def api_client_id(self, api_client_id):
        """Sets the api_client_id of this InlineObject5.

        Your API client ID  # noqa: E501

        :param api_client_id: The api_client_id of this InlineObject5.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and api_client_id is None:  # noqa: E501
            raise ValueError("Invalid value for `api_client_id`, must not be `None`")  # noqa: E501

        self._api_client_id = api_client_id

    @property
    def api_client_secret(self):
        """Gets the api_client_secret of this InlineObject5.  # noqa: E501

        Your API client secret  # noqa: E501

        :return: The api_client_secret of this InlineObject5.  # noqa: E501
        :rtype: str
        """
        return self._api_client_secret

    @api_client_secret.setter
    def api_client_secret(self, api_client_secret):
        """Sets the api_client_secret of this InlineObject5.

        Your API client secret  # noqa: E501

        :param api_client_secret: The api_client_secret of this InlineObject5.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and api_client_secret is None:  # noqa: E501
            raise ValueError("Invalid value for `api_client_secret`, must not be `None`")  # noqa: E501

        self._api_client_secret = api_client_secret

    @property
    def api_key(self):
        """Gets the api_key of this InlineObject5.  # noqa: E501

        API key for the company you want access to.  # noqa: E501

        :return: The api_key of this InlineObject5.  # noqa: E501
        :rtype: str
        """
    ...
    def api_key(self, api_key):
        """Sets the api_key of this InlineObject5.

        API key for the company you want access to.  # noqa: E501

        :param api_key: The api_key of this InlineObject5.  # noqa: E501
        :type: str
        """
