...
class V2BalanceTransferLeaveTransfers(object):
    ...
    def __init__(self, _from=None, to=None, local_vars_configuration=None):  # noqa: E501
        """V2BalanceTransferLeaveTransfers - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def _from(self):
        """Gets the _from of this V2BalanceTransferLeaveTransfers.  # noqa: E501

        Name of the leave account to transfer from  # noqa: E501

        :return: The _from of this V2BalanceTransferLeaveTransfers.  # noqa: E501
        :rtype: str
        """
        return self.__from
    ...
    def _from(self, _from):
        """Sets the _from of this V2BalanceTransferLeaveTransfers.

        Name of the leave account to transfer from  # noqa: E501

        :param _from: The _from of this V2BalanceTransferLeaveTransfers.  # noqa: E501
        :type: str
        """
    ...
    @property
    def to(self):
        """Gets the to of this V2BalanceTransferLeaveTransfers.  # noqa: E501

        Name of the leave account to transfer to  # noqa: E501

        :return: The to of this V2BalanceTransferLeaveTransfers.  # noqa: E501
        :rtype: str
        """
        return self._to
    ...
    @to.setter
    def to(self, to):
        """Sets the to of this V2BalanceTransferLeaveTransfers.

        Name of the leave account to transfer to  # noqa: E501

        :param to: The to of this V2BalanceTransferLeaveTransfers.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V2BalanceTransferLeaveTransfers):
            return False
