...
class PaySlipRows(object):
    ...
    def __init__(self, amount=None, rate=None, row=None, title=None, units=None, local_vars_configuration=None):  # noqa: E501
        """PaySlipRows - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def amount(self):
        """Gets the amount of this PaySlipRows.  # noqa: E501

        The amount of this calculation line. Will often be `rate` multiplied with `units`  # noqa: E501

        :return: The amount of this PaySlipRows.  # noqa: E501
        :rtype: float
        """
        return self._amount
    ...
    def amount(self, amount):
        """Sets the amount of this PaySlipRows.

        The amount of this calculation line. Will often be `rate` multiplied with `units`  # noqa: E501

        :param amount: The amount of this PaySlipRows.  # noqa: E501
        :type: float
        """
    ...
    @property
    def rate(self):
        """Gets the rate of this PaySlipRows.  # noqa: E501

        The rate of this calculation line  # noqa: E501

        :return: The rate of this PaySlipRows.  # noqa: E501
        :rtype: float
        """
        return self._rate
    ...
    @rate.setter
    def rate(self, rate):
        """Sets the rate of this PaySlipRows.

        The rate of this calculation line  # noqa: E501

        :param rate: The rate of this PaySlipRows.  # noqa: E501
        :type: float
        """
    ...
    @property
    def row(self):
        """Gets the row of this PaySlipRows.  # noqa: E501

        The number of the row, for ordering  # noqa: E501

        :return: The row of this PaySlipRows.  # noqa: E501
        :rtype: float
        """
        return self._row
    ...
    @row.setter
    def row(self, row):
        """Sets the row of this PaySlipRows.

        The number of the row, for ordering  # noqa: E501

        :param row: The row of this PaySlipRows.  # noqa: E501
        :type: float
        """
    ...
    @property
    def title(self):
        """Gets the title of this PaySlipRows.  # noqa: E501

        A textual description of the calcuation row  # noqa: E501

        :return: The title of this PaySlipRows.  # noqa: E501
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this PaySlipRows.

        A textual description of the calcuation row  # noqa: E501

        :param title: The title of this PaySlipRows.  # noqa: E501
        :type: str
        """
    ...
    @property
    def units(self):
        """Gets the units of this PaySlipRows.  # noqa: E501

        The unit amount of this calculation line  # noqa: E501

        :return: The units of this PaySlipRows.  # noqa: E501
        :rtype: float
        """
        return self._units
    ...
    def units(self, units):
        """Sets the units of this PaySlipRows.

        The unit amount of this calculation line  # noqa: E501

        :param units: The units of this PaySlipRows.  # noqa: E501
        :type: float
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaySlipRows):
            return False
