...
class InlineObject58(object):
    ...
    def __init__(self, setup_intent_id=None, local_vars_configuration=None):  # noqa: E501
        """InlineObject58 - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._setup_intent_id = None
        self.discriminator = None

        self.setup_intent_id = setup_intent_id

    @property
    def setup_intent_id(self):
        """Gets the setup_intent_id of this InlineObject58.  # noqa: E501


        :return: The setup_intent_id of this InlineObject58.  # noqa: E501
        :rtype: str
        """
        return self._setup_intent_id

    @setup_intent_id.setter
    def setup_intent_id(self, setup_intent_id):
        """Sets the setup_intent_id of this InlineObject58.


        :param setup_intent_id: The setup_intent_id of this InlineObject58.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and setup_intent_id is None:  # noqa: E501
            raise ValueError("Invalid value for `setup_intent_id`, must not be `None`")  # noqa: E501

        self._setup_intent_id = setup_intent_id
