...
class AccountingIntegrationSetupStatusDimensionValues(object):
    ...
    def __init__(self, cost_center_id=None, cost_center_name=None, dimension_value_id=None, dimension_value_name=None, local_vars_configuration=None):  # noqa: E501
        """AccountingIntegrationSetupStatusDimensionValues - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._cost_center_id = None
        self._cost_center_name = None
        self._dimension_value_id = None
    ...
    def cost_center_id(self):
        """Gets the cost_center_id of this AccountingIntegrationSetupStatusDimensionValues.  # noqa: E501

        The cost center we will map it to  # noqa: E501

        :return: The cost_center_id of this AccountingIntegrationSetupStatusDimensionValues.  # noqa: E501
        :rtype: str
        """
    ...
    def cost_center_id(self, cost_center_id):
        """Sets the cost_center_id of this AccountingIntegrationSetupStatusDimensionValues.

        The cost center we will map it to  # noqa: E501

        :param cost_center_id: The cost_center_id of this AccountingIntegrationSetupStatusDimensionValues.  # noqa: E501
        :type: str
        """
    ...
    def cost_center_name(self):
        """Gets the cost_center_name of this AccountingIntegrationSetupStatusDimensionValues.  # noqa: E501

        Name of cost center we will map it to  # noqa: E501

        :return: The cost_center_name of this AccountingIntegrationSetupStatusDimensionValues.  # noqa: E501
        :rtype: str
        """
        return self._cost_center_name

    @cost_center_name.setter
    def cost_center_name(self, cost_center_name):
        """Sets the cost_center_name of this AccountingIntegrationSetupStatusDimensionValues.

        Name of cost center we will map it to  # noqa: E501

        :param cost_center_name: The cost_center_name of this AccountingIntegrationSetupStatusDimensionValues.  # noqa: E501
        :type: str
        """

        self._cost_center_name = cost_center_name

    @property
    def dimension_value_id(self):
        """Gets the dimension_value_id of this AccountingIntegrationSetupStatusDimensionValues.  # noqa: E501


        :return: The dimension_value_id of this AccountingIntegrationSetupStatusDimensionValues.  # noqa: E501
        :rtype: str
        """
        return self._dimension_value_id

    @dimension_value_id.setter
    def dimension_value_id(self, dimension_value_id):
        """Sets the dimension_value_id of this AccountingIntegrationSetupStatusDimensionValues.


        :param dimension_value_id: The dimension_value_id of this AccountingIntegrationSetupStatusDimensionValues.  # noqa: E501
        :type: str
        """

        self._dimension_value_id = dimension_value_id

    @property
    def dimension_value_name(self):
        """Gets the dimension_value_name of this AccountingIntegrationSetupStatusDimensionValues.  # noqa: E501


        :return: The dimension_value_name of this AccountingIntegrationSetupStatusDimensionValues.  # noqa: E501
        :rtype: str
        """
    ...
    def dimension_value_name(self, dimension_value_name):
        """Sets the dimension_value_name of this AccountingIntegrationSetupStatusDimensionValues.


        :param dimension_value_name: The dimension_value_name of this AccountingIntegrationSetupStatusDimensionValues.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AccountingIntegrationSetupStatusDimensionValues):
            return False
