...
class InlineObject49(object):
    ...
    def __init__(self, channel=None, local_vars_configuration=None):  # noqa: E501
        """InlineObject49 - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def channel(self):
        """Gets the channel of this InlineObject49.  # noqa: E501

        The channel the user would like to use for MFA  # noqa: E501

        :return: The channel of this InlineObject49.  # noqa: E501
        :rtype: str
        """
    ...
    def channel(self, channel):
        """Sets the channel of this InlineObject49.

        The channel the user would like to use for MFA  # noqa: E501

        :param channel: The channel of this InlineObject49.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and channel is None:  # noqa: E501
            raise ValueError("Invalid value for `channel`, must not be `None`")  # noqa: E501
        allowed_values = ["SMS", "TOTP"]  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineObject49):
            return False
