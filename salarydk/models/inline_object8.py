...
class InlineObject8(object):
    ...
    def __init__(self, admin_note=None, local_vars_configuration=None):  # noqa: E501
        """InlineObject8 - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._admin_note = None
    ...
    @property
    def admin_note(self):
        """Gets the admin_note of this InlineObject8.  # noqa: E501


        :return: The admin_note of this InlineObject8.  # noqa: E501
        :rtype: str
        """
        return self._admin_note

    @admin_note.setter
    def admin_note(self, admin_note):
        """Sets the admin_note of this InlineObject8.


        :param admin_note: The admin_note of this InlineObject8.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and admin_note is None:  # noqa: E501
            raise ValueError("Invalid value for `admin_note`, must not be `None`")  # noqa: E501

        self._admin_note = admin_note
