...
class TimeRegistrationIntegrationSetupStatusSalaryTypes(object):
    ...
    def __init__(self, external_id=None, name=None, salary_type_id=None, local_vars_configuration=None):  # noqa: E501
        """TimeRegistrationIntegrationSetupStatusSalaryTypes - a model defined in OpenAPI"""  # noqa: E501
    ...
    def external_id(self):
        """Gets the external_id of this TimeRegistrationIntegrationSetupStatusSalaryTypes.  # noqa: E501

        The external ID for this salary type (hour type)  # noqa: E501

        :return: The external_id of this TimeRegistrationIntegrationSetupStatusSalaryTypes.  # noqa: E501
        :rtype: str
        """
    ...
    def external_id(self, external_id):
        """Sets the external_id of this TimeRegistrationIntegrationSetupStatusSalaryTypes.

        The external ID for this salary type (hour type)  # noqa: E501

        :param external_id: The external_id of this TimeRegistrationIntegrationSetupStatusSalaryTypes.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this TimeRegistrationIntegrationSetupStatusSalaryTypes.  # noqa: E501

        Name in the external system for this  # noqa: E501

        :return: The name of this TimeRegistrationIntegrationSetupStatusSalaryTypes.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this TimeRegistrationIntegrationSetupStatusSalaryTypes.

        Name in the external system for this  # noqa: E501

        :param name: The name of this TimeRegistrationIntegrationSetupStatusSalaryTypes.  # noqa: E501
        :type: str
        """
    ...
    def salary_type_id(self):
        """Gets the salary_type_id of this TimeRegistrationIntegrationSetupStatusSalaryTypes.  # noqa: E501

        Suggestion for internal salary type to help with easier mapping (has no actual impact on mapping)  # noqa: E501

        :return: The salary_type_id of this TimeRegistrationIntegrationSetupStatusSalaryTypes.  # noqa: E501
        :rtype: str
        """
    ...
    def salary_type_id(self, salary_type_id):
        """Sets the salary_type_id of this TimeRegistrationIntegrationSetupStatusSalaryTypes.

        Suggestion for internal salary type to help with easier mapping (has no actual impact on mapping)  # noqa: E501

        :param salary_type_id: The salary_type_id of this TimeRegistrationIntegrationSetupStatusSalaryTypes.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TimeRegistrationIntegrationSetupStatusSalaryTypes):
            return False
