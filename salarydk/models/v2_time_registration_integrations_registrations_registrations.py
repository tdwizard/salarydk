...
class V2TimeRegistrationIntegrationsRegistrationsRegistrations(object):
    ...
    def __init__(self, import_registration_id=None, salary_type_id=None, local_vars_configuration=None):  # noqa: E501
        """V2TimeRegistrationIntegrationsRegistrationsRegistrations - a model defined in OpenAPI"""  # noqa: E501
    ...
    def import_registration_id(self):
        """Gets the import_registration_id of this V2TimeRegistrationIntegrationsRegistrationsRegistrations.  # noqa: E501

        The temporary ID for the registration  # noqa: E501

        :return: The import_registration_id of this V2TimeRegistrationIntegrationsRegistrationsRegistrations.  # noqa: E501
        :rtype: str
        """
    ...
    def import_registration_id(self, import_registration_id):
        """Sets the import_registration_id of this V2TimeRegistrationIntegrationsRegistrationsRegistrations.

        The temporary ID for the registration  # noqa: E501

        :param import_registration_id: The import_registration_id of this V2TimeRegistrationIntegrationsRegistrationsRegistrations.  # noqa: E501
        :type: str
        """
    ...
    def salary_type_id(self):
        """Gets the salary_type_id of this V2TimeRegistrationIntegrationsRegistrationsRegistrations.  # noqa: E501

        The salary type for this specific registration  # noqa: E501

        :return: The salary_type_id of this V2TimeRegistrationIntegrationsRegistrationsRegistrations.  # noqa: E501
        :rtype: str
        """
    ...
    def salary_type_id(self, salary_type_id):
        """Sets the salary_type_id of this V2TimeRegistrationIntegrationsRegistrationsRegistrations.

        The salary type for this specific registration  # noqa: E501

        :param salary_type_id: The salary_type_id of this V2TimeRegistrationIntegrationsRegistrationsRegistrations.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V2TimeRegistrationIntegrationsRegistrationsRegistrations):
            return False
