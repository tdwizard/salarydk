...
class VacationCalendar(object):
    ...
    def __init__(self, days=None, local_vars_configuration=None):  # noqa: E501
        """VacationCalendar - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def days(self):
        """Gets the days of this VacationCalendar.  # noqa: E501


        :return: The days of this VacationCalendar.  # noqa: E501
        :rtype: list[VacationDay]
        """
        return self._days

    @days.setter
    def days(self, days):
        """Sets the days of this VacationCalendar.


        :param days: The days of this VacationCalendar.  # noqa: E501
        :type: list[VacationDay]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VacationCalendar):
            return False
