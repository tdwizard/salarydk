...
class InlineObject2(object):
    ...
    def __init__(self, cost_center_accounting=None, local_vars_configuration=None):  # noqa: E501
    ...
    def cost_center_accounting(self):
        """Gets the cost_center_accounting of this InlineObject2.  # noqa: E501

        Enable department or cost center accounting.  # noqa: E501

        :return: The cost_center_accounting of this InlineObject2.  # noqa: E501
        :rtype: str
        """
    ...
    def cost_center_accounting(self, cost_center_accounting):
        """Sets the cost_center_accounting of this InlineObject2.

        Enable department or cost center accounting.  # noqa: E501

        :param cost_center_accounting: The cost_center_accounting of this InlineObject2.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and cost_center_accounting is None:  # noqa: E501
            raise ValueError("Invalid value for `cost_center_accounting`, must not be `None`")  # noqa: E501
