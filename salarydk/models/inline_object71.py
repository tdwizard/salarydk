...
class InlineObject71(object):
    ...
    """
    openapi_types = {
        'employees': 'list[V2TimeRegistrationIntegrationsRegistrationsEmployees]',
        'registrations': 'list[V2TimeRegistrationIntegrationsRegistrationsRegistrations]',
        'salary_types': 'list[V2TimeRegistrationIntegrationsRegistrationsSalaryTypes]'
    }
    ...
    def __init__(self, employees=None, registrations=None, salary_types=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def employees(self):
        """Gets the employees of this InlineObject71.  # noqa: E501

        This array allows the client to associate employees from the external system with specific employees, useful if could not be done automatically  # noqa: E501

        :return: The employees of this InlineObject71.  # noqa: E501
        :rtype: list[V2TimeRegistrationIntegrationsRegistrationsEmployees]
        """
        return self._employees

    @employees.setter
    def employees(self, employees):
        """Sets the employees of this InlineObject71.

        This array allows the client to associate employees from the external system with specific employees, useful if could not be done automatically  # noqa: E501

        :param employees: The employees of this InlineObject71.  # noqa: E501
        :type: list[V2TimeRegistrationIntegrationsRegistrationsEmployees]
        """
    ...
    def registrations(self):
        """Gets the registrations of this InlineObject71.  # noqa: E501


        :return: The registrations of this InlineObject71.  # noqa: E501
        :rtype: list[V2TimeRegistrationIntegrationsRegistrationsRegistrations]
        """
        return self._registrations

    @registrations.setter
    def registrations(self, registrations):
        """Sets the registrations of this InlineObject71.


        :param registrations: The registrations of this InlineObject71.  # noqa: E501
        :type: list[V2TimeRegistrationIntegrationsRegistrationsRegistrations]
        """
    ...
    def salary_types(self):
        """Gets the salary_types of this InlineObject71.  # noqa: E501

        Generally speaking, this should already be associated correctly during the configuration of the integration, but if a new entry has been added, one can associate it with an existing one if necessary.   # noqa: E501

        :return: The salary_types of this InlineObject71.  # noqa: E501
        :rtype: list[V2TimeRegistrationIntegrationsRegistrationsSalaryTypes]
        """
        return self._salary_types

    @salary_types.setter
    def salary_types(self, salary_types):
        """Sets the salary_types of this InlineObject71.

        Generally speaking, this should already be associated correctly during the configuration of the integration, but if a new entry has been added, one can associate it with an existing one if necessary.   # noqa: E501

        :param salary_types: The salary_types of this InlineObject71.  # noqa: E501
        :type: list[V2TimeRegistrationIntegrationsRegistrationsSalaryTypes]
        """
