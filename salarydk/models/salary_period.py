...
class SalaryPeriod(object):
    ...
    def __init__(self, disposition_date=None, end=None, id=None, latest_start_time=None, start=None, local_vars_configuration=None):  # noqa: E501
        """SalaryPeriod - a model defined in OpenAPI"""  # noqa: E501
    ...
    def disposition_date(self):
        """Gets the disposition_date of this SalaryPeriod.  # noqa: E501

        The date the salary should be at disposition for the recipient.  # noqa: E501

        :return: The disposition_date of this SalaryPeriod.  # noqa: E501
        :rtype: date
        """
    ...
    def disposition_date(self, disposition_date):
        """Sets the disposition_date of this SalaryPeriod.

        The date the salary should be at disposition for the recipient.  # noqa: E501

        :param disposition_date: The disposition_date of this SalaryPeriod.  # noqa: E501
        :type: date
        """
    ...
    @property
    def end(self):
        """Gets the end of this SalaryPeriod.  # noqa: E501

        The end date of the period  # noqa: E501

        :return: The end of this SalaryPeriod.  # noqa: E501
        :rtype: date
        """
        return self._end
    ...
    @end.setter
    def end(self, end):
        """Sets the end of this SalaryPeriod.

        The end date of the period  # noqa: E501

        :param end: The end of this SalaryPeriod.  # noqa: E501
        :type: date
        """
    ...
    @property
    def id(self):
        """Gets the id of this SalaryPeriod.  # noqa: E501

        The ID of the salary period  # noqa: E501

        :return: The id of this SalaryPeriod.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this SalaryPeriod.

        The ID of the salary period  # noqa: E501

        :param id: The id of this SalaryPeriod.  # noqa: E501
        :type: str
        """
    ...
    def latest_start_time(self):
        """Gets the latest_start_time of this SalaryPeriod.  # noqa: E501

        The latest time to start a pay roll run for this period in order to still make it before the deadline.  # noqa: E501

        :return: The latest_start_time of this SalaryPeriod.  # noqa: E501
        :rtype: datetime
        """
        return self._latest_start_time

    @latest_start_time.setter
    def latest_start_time(self, latest_start_time):
        """Sets the latest_start_time of this SalaryPeriod.

        The latest time to start a pay roll run for this period in order to still make it before the deadline.  # noqa: E501

        :param latest_start_time: The latest_start_time of this SalaryPeriod.  # noqa: E501
        :type: datetime
        """

        self._latest_start_time = latest_start_time

    @property
    def start(self):
        """Gets the start of this SalaryPeriod.  # noqa: E501

        The start date of the period  # noqa: E501

        :return: The start of this SalaryPeriod.  # noqa: E501
        :rtype: date
        """
        return self._start
    ...
    def start(self, start):
        """Sets the start of this SalaryPeriod.

        The start date of the period  # noqa: E501

        :param start: The start of this SalaryPeriod.  # noqa: E501
        :type: date
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SalaryPeriod):
            return False
