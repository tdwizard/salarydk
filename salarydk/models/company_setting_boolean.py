...
class CompanySettingBoolean(object):
    ...
    allowed enum values
    """
    ALWAYSCURRENTPAYROLLRUNENABLED = "AlwaysCurrentPayRollRunEnabled"
    ALLOWCUSTOMPDFPASSWORD = "AllowCustomPDFPassword"
    VACATIONACCOUNTING = "VacationAccounting"
    EARLYPAYMENTS = "EarlyPayments"
    DKAUTOZEROTAXREPORT = "DKAutoZeroTaxReport"
    ALLOWPAYROLLREVIEW = "AllowPayRollReview"
    NEGATINGPAYROLLENABLED = "NegatingPayRollEnabled"
    EMPTYTAXCARDMAILENABLED = "EmptyTaxCardMailEnabled"
    ONETIMEPAYACCOUNTINGTEXTENABLED = "OneTimePayAccountingTextEnabled"
    YEARLYSALARYSTATISTICS = "YearlySalaryStatistics"
    QUARTERLYSALARYSTATISTICS = "QuarterlySalaryStatistics"
    ABSENCESTATISTICS = "AbsenceStatistics"
    MOREINCOMETYPES = "MoreIncomeTypes"
    MOREBONUSOPTIONS = "MoreBonusOptions"
    ALLOWNOCPR = "AllowNoCPR"
    ALLOWFREELANCERCVR = "AllowFreelancerCVR"
    SHDAGEFRITVALGINCREASETYPES = "SHDageFritvalgIncreaseTypes"
    ALLOWDAYLABORER = "AllowDayLaborer"
    ALLOWVACATIONFUND = "AllowVacationFund"
    ALLOWLEAVETYPEEMPLOYEESELECTABLE = "AllowLeaveTypeEmployeeSelectable"
    DISABLEAPPTIMEREGISTRATION = "DisableAppTimeRegistration"
    DEPARTMENTSELECTTIMEREGISTRATION = "DepartmentSelectTimeRegistration"
    ASKFOROTPDRAFTSTATE = "AskForOTPDraftState"
    REGISTERTIMEREGISTRATIONSTARTEND = "RegisterTimeRegistrationStartEnd"
    ALLOWNETPENSION = "AllowNetPension"

    allowable_values = [ALWAYSCURRENTPAYROLLRUNENABLED, ALLOWCUSTOMPDFPASSWORD, VACATIONACCOUNTING, EARLYPAYMENTS, DKAUTOZEROTAXREPORT, ALLOWPAYROLLREVIEW, NEGATINGPAYROLLENABLED, EMPTYTAXCARDMAILENABLED, ONETIMEPAYACCOUNTINGTEXTENABLED, YEARLYSALARYSTATISTICS, QUARTERLYSALARYSTATISTICS, ABSENCESTATISTICS, MOREINCOMETYPES, MOREBONUSOPTIONS, ALLOWNOCPR, ALLOWFREELANCERCVR, SHDAGEFRITVALGINCREASETYPES, ALLOWDAYLABORER, ALLOWVACATIONFUND, ALLOWLEAVETYPEEMPLOYEESELECTABLE, DISABLEAPPTIMEREGISTRATION, DEPARTMENTSELECTTIMEREGISTRATION, ASKFOROTPDRAFTSTATE, REGISTERTIMEREGISTRATIONSTARTEND, ALLOWNETPENSION]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """CompanySettingBoolean - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CompanySettingBoolean):
            return False
