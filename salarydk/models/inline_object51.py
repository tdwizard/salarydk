...
class InlineObject51(object):
    ...
    def __init__(self, company_id=None, lead_type=None, local_vars_configuration=None):  # noqa: E501
        """InlineObject51 - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def company_id(self):
        """Gets the company_id of this InlineObject51.  # noqa: E501


        :return: The company_id of this InlineObject51.  # noqa: E501
        :rtype: str
        """
    ...
    def company_id(self, company_id):
        """Sets the company_id of this InlineObject51.


        :param company_id: The company_id of this InlineObject51.  # noqa: E501
        :type: str
        """
    ...
    @property
    def lead_type(self):
        """Gets the lead_type of this InlineObject51.  # noqa: E501


        :return: The lead_type of this InlineObject51.  # noqa: E501
        :rtype: str
        """
    ...
    def lead_type(self, lead_type):
        """Sets the lead_type of this InlineObject51.


        :param lead_type: The lead_type of this InlineObject51.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and lead_type is None:  # noqa: E501
            raise ValueError("Invalid value for `lead_type`, must not be `None`")  # noqa: E501
        allowed_values = ["DK Codan New Customer", "DK Codan Changed Employee Count"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and lead_type not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `lead_type` ({0}), must be one of {1}"  # noqa: E501
                .format(lead_type, allowed_values)
            )
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineObject51):
            return False
