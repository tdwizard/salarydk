...
class InlineObject39(object):
    ...
    def __init__(self, password=None, local_vars_configuration=None):  # noqa: E501
        """InlineObject39 - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def password(self):
        """Gets the password of this InlineObject39.  # noqa: E501

        The password to use for the PDF password. If empty, defaults to using the national ID of the employee.  # noqa: E501

        :return: The password of this InlineObject39.  # noqa: E501
        :rtype: str
        """
    ...
    def password(self, password):
        """Sets the password of this InlineObject39.

        The password to use for the PDF password. If empty, defaults to using the national ID of the employee.  # noqa: E501

        :param password: The password of this InlineObject39.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineObject39):
            return False
