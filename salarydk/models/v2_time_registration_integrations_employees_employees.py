...
class V2TimeRegistrationIntegrationsEmployeesEmployees(object):
    ...
    def __init__(self, address=None, city=None, employee_id=None, import_employee_id=None, national_id=None, local_vars_configuration=None):  # noqa: E501
        """V2TimeRegistrationIntegrationsEmployeesEmployees - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def address(self):
        """Gets the address of this V2TimeRegistrationIntegrationsEmployeesEmployees.  # noqa: E501

        Set their address manually  # noqa: E501

        :return: The address of this V2TimeRegistrationIntegrationsEmployeesEmployees.  # noqa: E501
        :rtype: str
        """
    ...
    def address(self, address):
        """Sets the address of this V2TimeRegistrationIntegrationsEmployeesEmployees.

        Set their address manually  # noqa: E501

        :param address: The address of this V2TimeRegistrationIntegrationsEmployeesEmployees.  # noqa: E501
        :type: str
        """
    ...
    @property
    def city(self):
        """Gets the city of this V2TimeRegistrationIntegrationsEmployeesEmployees.  # noqa: E501

        Set their city manually  # noqa: E501

        :return: The city of this V2TimeRegistrationIntegrationsEmployeesEmployees.  # noqa: E501
        :rtype: str
        """
        return self._city
    ...
    @city.setter
    def city(self, city):
        """Sets the city of this V2TimeRegistrationIntegrationsEmployeesEmployees.

        Set their city manually  # noqa: E501

        :param city: The city of this V2TimeRegistrationIntegrationsEmployeesEmployees.  # noqa: E501
        :type: str
        """
    ...
    def employee_id(self):
        """Gets the employee_id of this V2TimeRegistrationIntegrationsEmployeesEmployees.  # noqa: E501

        The ID of the employee in Salary  # noqa: E501

        :return: The employee_id of this V2TimeRegistrationIntegrationsEmployeesEmployees.  # noqa: E501
        :rtype: str
        """
    ...
    def employee_id(self, employee_id):
        """Sets the employee_id of this V2TimeRegistrationIntegrationsEmployeesEmployees.

        The ID of the employee in Salary  # noqa: E501

        :param employee_id: The employee_id of this V2TimeRegistrationIntegrationsEmployeesEmployees.  # noqa: E501
        :type: str
        """
    ...
    def import_employee_id(self):
        """Gets the import_employee_id of this V2TimeRegistrationIntegrationsEmployeesEmployees.  # noqa: E501

        The temporary ID for this employee about to be imported  # noqa: E501

        :return: The import_employee_id of this V2TimeRegistrationIntegrationsEmployeesEmployees.  # noqa: E501
        :rtype: str
        """
    ...
    def import_employee_id(self, import_employee_id):
        """Sets the import_employee_id of this V2TimeRegistrationIntegrationsEmployeesEmployees.

        The temporary ID for this employee about to be imported  # noqa: E501

        :param import_employee_id: The import_employee_id of this V2TimeRegistrationIntegrationsEmployeesEmployees.  # noqa: E501
        :type: str
        """
    ...
    def national_id(self):
        """Gets the national_id of this V2TimeRegistrationIntegrationsEmployeesEmployees.  # noqa: E501

        Set their national ID manually  # noqa: E501

        :return: The national_id of this V2TimeRegistrationIntegrationsEmployeesEmployees.  # noqa: E501
        :rtype: str
        """
    ...
    def national_id(self, national_id):
        """Sets the national_id of this V2TimeRegistrationIntegrationsEmployeesEmployees.

        Set their national ID manually  # noqa: E501

        :param national_id: The national_id of this V2TimeRegistrationIntegrationsEmployeesEmployees.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V2TimeRegistrationIntegrationsEmployeesEmployees):
            return False
