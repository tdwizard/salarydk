...
class VacationDay(object):
    ...
    def __init__(self, day=None, named_day=None, type=None, local_vars_configuration=None):  # noqa: E501
        """VacationDay - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._day = None
        self._named_day = None
        self._type = None
        self.discriminator = None

        self.day = day
        self.named_day = named_day
        self.type = type

    @property
    def day(self):
        """Gets the day of this VacationDay.  # noqa: E501

        Vacation day definition given a date where the year is redundant  # noqa: E501

        :return: The day of this VacationDay.  # noqa: E501
        :rtype: date
        """
        return self._day
    ...
    @day.setter
    def day(self, day):
        """Sets the day of this VacationDay.

        Vacation day definition given a date where the year is redundant  # noqa: E501

        :param day: The day of this VacationDay.  # noqa: E501
        :type: date
        """
    ...
    @property
    def named_day(self):
        """Gets the named_day of this VacationDay.  # noqa: E501

        Vacation day definition given by a named date  # noqa: E501

        :return: The named_day of this VacationDay.  # noqa: E501
        :rtype: str
        """
        return self._named_day

    @named_day.setter
    def named_day(self, named_day):
        """Sets the named_day of this VacationDay.

        Vacation day definition given by a named date  # noqa: E501

        :param named_day: The named_day of this VacationDay.  # noqa: E501
        :type: str
        """
        allowed_values = [None,"Palm Sunday", "Maundy Thursday", "Good Friday", "Easter Sunday", "Easter Monday", "General Prayer Day", "Christ Ascension", "The Day After Christ Ascension", "First Day Of Pentecost", "Whit Monday"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and named_day not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `named_day` ({0}), must be one of {1}"  # noqa: E501
                .format(named_day, allowed_values)
            )

        self._named_day = named_day

    @property
    def type(self):
        """Gets the type of this VacationDay.  # noqa: E501

        The type of the vacation day.  # noqa: E501

        :return: The type of this VacationDay.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this VacationDay.

        The type of the vacation day.  # noqa: E501

        :param type: The type of this VacationDay.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and type is None:  # noqa: E501
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["Vacation Day", "Half Vacation Day", "Work Day"]  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VacationDay):
            return False
