...
class ContractBookCallbackContract(object):
    ...
    def __init__(self, id=None, state=None, local_vars_configuration=None):  # noqa: E501
        """ContractBookCallbackContract - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this ContractBookCallbackContract.  # noqa: E501


        :return: The id of this ContractBookCallbackContract.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ContractBookCallbackContract.


        :param id: The id of this ContractBookCallbackContract.  # noqa: E501
        :type: str
        """
    ...
    @property
    def state(self):
        """Gets the state of this ContractBookCallbackContract.  # noqa: E501


        :return: The state of this ContractBookCallbackContract.  # noqa: E501
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        """Sets the state of this ContractBookCallbackContract.


        :param state: The state of this ContractBookCallbackContract.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ContractBookCallbackContract):
            return False
