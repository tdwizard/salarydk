...
class InlineObject75(object):
    ...
    def __init__(self, action='changeSettings', automated=None, date=None, payment_method=None, local_vars_configuration=None):  # noqa: E501
        """InlineObject75 - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def action(self):
        """Gets the action of this InlineObject75.  # noqa: E501

        Action `changeSettings` is `date` and `paymentMethod` (i.e. old behaviour), `tryAgain` attempts a failed transfer again  # noqa: E501

        :return: The action of this InlineObject75.  # noqa: E501
        :rtype: str
        """
        return self._action
    ...
    def action(self, action):
        """Sets the action of this InlineObject75.

        Action `changeSettings` is `date` and `paymentMethod` (i.e. old behaviour), `tryAgain` attempts a failed transfer again  # noqa: E501

        :param action: The action of this InlineObject75.  # noqa: E501
        :type: str
        """
        allowed_values = ["changeSettings", "date", "paymentMethod", "tryAgain"]  # noqa: E501
    ...
    @property
    def automated(self):
        """Gets the automated of this InlineObject75.  # noqa: E501

        Deprecated.  Old way to set `paymentMethod` `true` => NETS, `false` => Manual  # noqa: E501

        :return: The automated of this InlineObject75.  # noqa: E501
        :rtype: bool
        """
    ...
    def automated(self, automated):
        """Sets the automated of this InlineObject75.

        Deprecated.  Old way to set `paymentMethod` `true` => NETS, `false` => Manual  # noqa: E501

        :param automated: The automated of this InlineObject75.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def date(self):
        """Gets the date of this InlineObject75.  # noqa: E501

        Set the new date of a transfer  # noqa: E501

        :return: The date of this InlineObject75.  # noqa: E501
        :rtype: date
        """
        return self._date
    ...
    @date.setter
    def date(self, date):
        """Sets the date of this InlineObject75.

        Set the new date of a transfer  # noqa: E501

        :param date: The date of this InlineObject75.  # noqa: E501
        :type: date
        """
    ...
    def payment_method(self):
        """Gets the payment_method of this InlineObject75.  # noqa: E501


        :return: The payment_method of this InlineObject75.  # noqa: E501
        :rtype: str
        """
    ...
    def payment_method(self, payment_method):
        """Sets the payment_method of this InlineObject75.


        :param payment_method: The payment_method of this InlineObject75.  # noqa: E501
        :type: str
        """
        allowed_values = [None,"Manual", "NETS", "Stripe"]  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineObject75):
            return False
