...
class ProductionUnit(object):
    ...
    attribute_map = {
        ...
        'id': 'id',
        'name': 'name',
        'production_unit_number': 'productionUnitNumber'
    }

    def __init__(self, active=None, id=None, name=None, production_unit_number=None, local_vars_configuration=None):  # noqa: E501
        """ProductionUnit - a model defined in OpenAPI"""  # noqa: E501
        ...
        self._id = None
        self._name = None
        self._production_unit_number = None
        ...
        if id is not None:
            self.id = id
        self.name = name
        self.production_unit_number = production_unit_number

    @property
    def active(self):
        """Gets the active of this ProductionUnit.  # noqa: E501

        Determines whether the production unit is active or not.  # noqa: E501

        :return: The active of this ProductionUnit.  # noqa: E501
        :rtype: bool
        """
        return self._active
    ...
    def active(self, active):
        """Sets the active of this ProductionUnit.

        Determines whether the production unit is active or not.  # noqa: E501

        :param active: The active of this ProductionUnit.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def id(self):
        """Gets the id of this ProductionUnit.  # noqa: E501

        The ID of the production unit  # noqa: E501

        :return: The id of this ProductionUnit.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ProductionUnit.

        The ID of the production unit  # noqa: E501

        :param id: The id of this ProductionUnit.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this ProductionUnit.  # noqa: E501

        The name of the production unit.  # noqa: E501

        :return: The name of this ProductionUnit.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ProductionUnit.

        The name of the production unit.  # noqa: E501

        :param name: The name of this ProductionUnit.  # noqa: E501
        :type: str
        """
    ...
    @property
    def production_unit_number(self):
        """Gets the production_unit_number of this ProductionUnit.  # noqa: E501

        The public number of the production unit, as referenced by tax authorities.  # noqa: E501

        :return: The production_unit_number of this ProductionUnit.  # noqa: E501
        :rtype: str
        """
        return self._production_unit_number

    @production_unit_number.setter
    def production_unit_number(self, production_unit_number):
        """Sets the production_unit_number of this ProductionUnit.

        The public number of the production unit, as referenced by tax authorities.  # noqa: E501

        :param production_unit_number: The production_unit_number of this ProductionUnit.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and production_unit_number is None:  # noqa: E501
            raise ValueError("Invalid value for `production_unit_number`, must not be `None`")  # noqa: E501

        self._production_unit_number = production_unit_number
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProductionUnit):
            return False
