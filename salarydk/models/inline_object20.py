...
class InlineObject20(object):
    ...
    openapi_types = {
        'action': 'str',
        'company_settings_disable': 'list[CompanySettingBoolean]',
        'company_settings_enable': 'list[CompanySettingBoolean]',
        'retroactive': 'bool'
    }

    attribute_map = {
        'action': 'action',
        'company_settings_disable': 'companySettingsDisable',
        'company_settings_enable': 'companySettingsEnable',
        'retroactive': 'retroactive'
    }

    def __init__(self, action=None, company_settings_disable=None, company_settings_enable=None, retroactive=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._action = None
        self._company_settings_disable = None
        self._company_settings_enable = None
        self._retroactive = None
        self.discriminator = None

        self.action = action
        if company_settings_disable is not None:
            self.company_settings_disable = company_settings_disable
        if company_settings_enable is not None:
            self.company_settings_enable = company_settings_enable
        if retroactive is not None:
            self.retroactive = retroactive

    @property
    def action(self):
        """Gets the action of this InlineObject20.  # noqa: E501

        `SetCompanySettings` sets the settings that will be applied when new companies are added to the group.   # noqa: E501

        :return: The action of this InlineObject20.  # noqa: E501
        :rtype: str
        """
        return self._action
    ...
    def action(self, action):
        """Sets the action of this InlineObject20.

        `SetCompanySettings` sets the settings that will be applied when new companies are added to the group.   # noqa: E501

        :param action: The action of this InlineObject20.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and action is None:  # noqa: E501
            raise ValueError("Invalid value for `action`, must not be `None`")  # noqa: E501
        allowed_values = ["SetCompanySettings"]  # noqa: E501
    ...
    @property
    def company_settings_disable(self):
        """Gets the company_settings_disable of this InlineObject20.  # noqa: E501

        Settings to explicitly disable for `SetCompanySettings`  # noqa: E501

        :return: The company_settings_disable of this InlineObject20.  # noqa: E501
        :rtype: list[CompanySettingBoolean]
        """
        return self._company_settings_disable

    @company_settings_disable.setter
    def company_settings_disable(self, company_settings_disable):
        """Sets the company_settings_disable of this InlineObject20.

        Settings to explicitly disable for `SetCompanySettings`  # noqa: E501

        :param company_settings_disable: The company_settings_disable of this InlineObject20.  # noqa: E501
        :type: list[CompanySettingBoolean]
        """

        self._company_settings_disable = company_settings_disable

    @property
    def company_settings_enable(self):
        """Gets the company_settings_enable of this InlineObject20.  # noqa: E501

        Settings to explicitly enable for `SetCompanySettings`  # noqa: E501

        :return: The company_settings_enable of this InlineObject20.  # noqa: E501
        :rtype: list[CompanySettingBoolean]
        """
        return self._company_settings_enable

    @company_settings_enable.setter
    def company_settings_enable(self, company_settings_enable):
        """Sets the company_settings_enable of this InlineObject20.

        Settings to explicitly enable for `SetCompanySettings`  # noqa: E501

        :param company_settings_enable: The company_settings_enable of this InlineObject20.  # noqa: E501
        :type: list[CompanySettingBoolean]
        """

        self._company_settings_enable = company_settings_enable

    @property
    def retroactive(self):
        """Gets the retroactive of this InlineObject20.  # noqa: E501

        Whether to change these settings for existing companies in the group.  # noqa: E501

        :return: The retroactive of this InlineObject20.  # noqa: E501
        :rtype: bool
        """
        return self._retroactive

    @retroactive.setter
    def retroactive(self, retroactive):
        """Sets the retroactive of this InlineObject20.

        Whether to change these settings for existing companies in the group.  # noqa: E501

        :param retroactive: The retroactive of this InlineObject20.  # noqa: E501
        :type: bool
        """
