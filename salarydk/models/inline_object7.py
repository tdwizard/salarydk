...
class InlineObject7(object):
    ...
    """
    openapi_types = {
        'chapters': 'list[V2BooksDraftChapters]'
    }
    ...
    def __init__(self, chapters=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def chapters(self):
        """Gets the chapters of this InlineObject7.  # noqa: E501


        :return: The chapters of this InlineObject7.  # noqa: E501
        :rtype: list[V2BooksDraftChapters]
        """
        return self._chapters

    @chapters.setter
    def chapters(self, chapters):
        """Sets the chapters of this InlineObject7.


        :param chapters: The chapters of this InlineObject7.  # noqa: E501
        :type: list[V2BooksDraftChapters]
        """
        if self.local_vars_configuration.client_side_validation and chapters is None:  # noqa: E501
            raise ValueError("Invalid value for `chapters`, must not be `None`")  # noqa: E501
