...
class InlineObject38(object):
    ...
    def __init__(self, leave_from=None, leave_to=None, local_vars_configuration=None):  # noqa: E501
        """InlineObject38 - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._leave_from = None
        self._leave_to = None
    ...
    @property
    def leave_from(self):
        """Gets the leave_from of this InlineObject38.  # noqa: E501


        :return: The leave_from of this InlineObject38.  # noqa: E501
        :rtype: date
        """
        return self._leave_from

    @leave_from.setter
    def leave_from(self, leave_from):
        """Sets the leave_from of this InlineObject38.


        :param leave_from: The leave_from of this InlineObject38.  # noqa: E501
        :type: date
        """
        if self.local_vars_configuration.client_side_validation and leave_from is None:  # noqa: E501
            raise ValueError("Invalid value for `leave_from`, must not be `None`")  # noqa: E501

        self._leave_from = leave_from

    @property
    def leave_to(self):
        """Gets the leave_to of this InlineObject38.  # noqa: E501


        :return: The leave_to of this InlineObject38.  # noqa: E501
        :rtype: date
        """
        return self._leave_to

    @leave_to.setter
    def leave_to(self, leave_to):
        """Sets the leave_to of this InlineObject38.


        :param leave_to: The leave_to of this InlineObject38.  # noqa: E501
        :type: date
        """
        if self.local_vars_configuration.client_side_validation and leave_to is None:  # noqa: E501
            raise ValueError("Invalid value for `leave_to`, must not be `None`")  # noqa: E501

        self._leave_to = leave_to
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineObject38):
            return False
