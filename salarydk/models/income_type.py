...
class IncomeType(object):
    ...
    allowed enum values
    """
    DKSALARYINCOME = "DKSalaryIncome"
    DKBINCOME = "DKBIncome"
    DKRESEARCHINCOME = "DKResearchIncome"
    DKCONTRIBUTIONFREE = "DKContributionFree"
    DKCONTRIBUTIONFREEAM = "DKContributionFreeAM"
    DKCONTRIBUTIONFREEABROAD = "DKContributionFreeAbroad"

    allowable_values = [DKSALARYINCOME, DKBINCOME, DKRESEARCHINCOME, DKCONTRIBUTIONFREE, DKCONTRIBUTIONFREEAM, DKCONTRIBUTIONFREEABROAD]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """IncomeType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IncomeType):
            return False
