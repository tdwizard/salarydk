...
class V2TimeRegistrationIntegrationsEmployeesSalaryTypes(object):
    ...
    def __init__(self, import_salary_type_id=None, rate=None, salary_type_id=None, local_vars_configuration=None):  # noqa: E501
        """V2TimeRegistrationIntegrationsEmployeesSalaryTypes - a model defined in OpenAPI"""  # noqa: E501
    ...
    def import_salary_type_id(self):
        """Gets the import_salary_type_id of this V2TimeRegistrationIntegrationsEmployeesSalaryTypes.  # noqa: E501

        The temporary ID for this salary type on whatever employee it was  # noqa: E501

        :return: The import_salary_type_id of this V2TimeRegistrationIntegrationsEmployeesSalaryTypes.  # noqa: E501
        :rtype: str
        """
    ...
    def import_salary_type_id(self, import_salary_type_id):
        """Sets the import_salary_type_id of this V2TimeRegistrationIntegrationsEmployeesSalaryTypes.

        The temporary ID for this salary type on whatever employee it was  # noqa: E501

        :param import_salary_type_id: The import_salary_type_id of this V2TimeRegistrationIntegrationsEmployeesSalaryTypes.  # noqa: E501
        :type: str
        """
    ...
    @property
    def rate(self):
        """Gets the rate of this V2TimeRegistrationIntegrationsEmployeesSalaryTypes.  # noqa: E501

        Set a rate for this.  If a rate is not set, this type will not be imported  # noqa: E501

        :return: The rate of this V2TimeRegistrationIntegrationsEmployeesSalaryTypes.  # noqa: E501
        :rtype: float
        """
        return self._rate
    ...
    @rate.setter
    def rate(self, rate):
        """Sets the rate of this V2TimeRegistrationIntegrationsEmployeesSalaryTypes.

        Set a rate for this.  If a rate is not set, this type will not be imported  # noqa: E501

        :param rate: The rate of this V2TimeRegistrationIntegrationsEmployeesSalaryTypes.  # noqa: E501
        :type: float
        """
    ...
    def salary_type_id(self):
        """Gets the salary_type_id of this V2TimeRegistrationIntegrationsEmployeesSalaryTypes.  # noqa: E501

        Change to which Salary's salary type  # noqa: E501

        :return: The salary_type_id of this V2TimeRegistrationIntegrationsEmployeesSalaryTypes.  # noqa: E501
        :rtype: str
        """
    ...
    def salary_type_id(self, salary_type_id):
        """Sets the salary_type_id of this V2TimeRegistrationIntegrationsEmployeesSalaryTypes.

        Change to which Salary's salary type  # noqa: E501

        :param salary_type_id: The salary_type_id of this V2TimeRegistrationIntegrationsEmployeesSalaryTypes.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V2TimeRegistrationIntegrationsEmployeesSalaryTypes):
            return False
