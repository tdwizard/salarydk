...
class SalaryType(object):
    ...
    openapi_types = {
        ...
        'id': 'str',
        'name': 'str',
        'supplements': 'list[SalaryTypeSupplements]',
        'title': 'str'
    }
    ...
    def __init__(self, active=None, _class=None, company_id=None, id=None, name=None, supplements=None, title=None, local_vars_configuration=None):  # noqa: E501
        """SalaryType - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def active(self):
        """Gets the active of this SalaryType.  # noqa: E501

        Indicates whether the salary type is available for new employees.  # noqa: E501

        :return: The active of this SalaryType.  # noqa: E501
        :rtype: bool
        """
        return self._active
    ...
    def active(self, active):
        """Sets the active of this SalaryType.

        Indicates whether the salary type is available for new employees.  # noqa: E501

        :param active: The active of this SalaryType.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def _class(self):
        """Gets the _class of this SalaryType.  # noqa: E501

        The type of the salary type. Only salary types with `Hourly` can be used for registering hours.  # noqa: E501

        :return: The _class of this SalaryType.  # noqa: E501
        :rtype: str
        """
        return self.__class
    ...
    def _class(self, _class):
        """Sets the _class of this SalaryType.

        The type of the salary type. Only salary types with `Hourly` can be used for registering hours.  # noqa: E501

        :param _class: The _class of this SalaryType.  # noqa: E501
        :type: str
        """
        ...
        allowed_values = ["Fixed", "Supplement", "SupplementVaried", "Hourly", "HourlyAggregate"]  # noqa: E501
    ...
    @property
    def company_id(self):
        """Gets the company_id of this SalaryType.  # noqa: E501

        The company this salary type is valid for. Different companies might have different valid types.  # noqa: E501

        :return: The company_id of this SalaryType.  # noqa: E501
        :rtype: str
        """
    ...
    def company_id(self, company_id):
        """Sets the company_id of this SalaryType.

        The company this salary type is valid for. Different companies might have different valid types.  # noqa: E501

        :param company_id: The company_id of this SalaryType.  # noqa: E501
        :type: str
        """
    ...
    @property
    def id(self):
        """Gets the id of this SalaryType.  # noqa: E501

        The ID of the salary type.  # noqa: E501

        :return: The id of this SalaryType.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this SalaryType.

        The ID of the salary type.  # noqa: E501

        :param id: The id of this SalaryType.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this SalaryType.  # noqa: E501

        The internal name of the salary type. This is used when registering hours for an employee.  # noqa: E501

        :return: The name of this SalaryType.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SalaryType.

        The internal name of the salary type. This is used when registering hours for an employee.  # noqa: E501

        :param name: The name of this SalaryType.  # noqa: E501
        :type: str
        """
    ...
    def supplements(self):
        """Gets the supplements of this SalaryType.  # noqa: E501


        :return: The supplements of this SalaryType.  # noqa: E501
        :rtype: list[SalaryTypeSupplements]
        """
        return self._supplements

    @supplements.setter
    def supplements(self, supplements):
        """Sets the supplements of this SalaryType.


        :param supplements: The supplements of this SalaryType.  # noqa: E501
        :type: list[SalaryTypeSupplements]
        """
    ...
    @property
    def title(self):
        """Gets the title of this SalaryType.  # noqa: E501

        The display name of the salary type. This is used when selecting a salary type from a list.  # noqa: E501

        :return: The title of this SalaryType.  # noqa: E501
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this SalaryType.

        The display name of the salary type. This is used when selecting a salary type from a list.  # noqa: E501

        :param title: The title of this SalaryType.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SalaryType):
            return False
