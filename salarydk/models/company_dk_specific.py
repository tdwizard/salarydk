...
class CompanyDkSpecific(object):
    ...
    """
    openapi_types = {
        'allow_automatic_zero_tax_report': 'bool',
        'skat_size': 'str'
    }

    attribute_map = {
        'allow_automatic_zero_tax_report': 'allowAutomaticZeroTaxReport',
        'skat_size': 'skatSize'
    }

    def __init__(self, allow_automatic_zero_tax_report=None, skat_size=None, local_vars_configuration=None):  # noqa: E501
        """CompanyDkSpecific - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._allow_automatic_zero_tax_report = None
        self._skat_size = None
        self.discriminator = None

        self.allow_automatic_zero_tax_report = allow_automatic_zero_tax_report
        self.skat_size = skat_size

    @property
    def allow_automatic_zero_tax_report(self):
        """Gets the allow_automatic_zero_tax_report of this CompanyDkSpecific.  # noqa: E501

        Determines if automatic zero tax reporting may be performed.  # noqa: E501

        :return: The allow_automatic_zero_tax_report of this CompanyDkSpecific.  # noqa: E501
        :rtype: bool
        """
        return self._allow_automatic_zero_tax_report

    @allow_automatic_zero_tax_report.setter
    def allow_automatic_zero_tax_report(self, allow_automatic_zero_tax_report):
        """Sets the allow_automatic_zero_tax_report of this CompanyDkSpecific.

        Determines if automatic zero tax reporting may be performed.  # noqa: E501

        :param allow_automatic_zero_tax_report: The allow_automatic_zero_tax_report of this CompanyDkSpecific.  # noqa: E501
        :type: bool
        """
        if self.local_vars_configuration.client_side_validation and allow_automatic_zero_tax_report is None:  # noqa: E501
            raise ValueError("Invalid value for `allow_automatic_zero_tax_report`, must not be `None`")  # noqa: E501

        self._allow_automatic_zero_tax_report = allow_automatic_zero_tax_report

    @property
    def skat_size(self):
        """Gets the skat_size of this CompanyDkSpecific.  # noqa: E501

        The size of the company in the eyes of SKAT with regards to payment dates  # noqa: E501

        :return: The skat_size of this CompanyDkSpecific.  # noqa: E501
        :rtype: str
        """
        return self._skat_size

    @skat_size.setter
    def skat_size(self, skat_size):
        """Sets the skat_size of this CompanyDkSpecific.

        The size of the company in the eyes of SKAT with regards to payment dates  # noqa: E501

        :param skat_size: The skat_size of this CompanyDkSpecific.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and skat_size is None:  # noqa: E501
            raise ValueError("Invalid value for `skat_size`, must not be `None`")  # noqa: E501
        allowed_values = ["Small", "Large"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and skat_size not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `skat_size` ({0}), must be one of {1}"  # noqa: E501
                .format(skat_size, allowed_values)
            )

        self._skat_size = skat_size
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CompanyDkSpecific):
            return False
