...
class EmployeesImportSalaryTypes(object):
    ...
    def __init__(self, can_import=None, external_type=None, import_salary_type_id=None, rate=None, salary_type=None, salary_type_id=None, local_vars_configuration=None):  # noqa: E501
        """EmployeesImportSalaryTypes - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def can_import(self):
        """Gets the can_import of this EmployeesImportSalaryTypes.  # noqa: E501

        Whether this salary type can be imported as is (usually if salaryTypeID is missing, it cannot)  # noqa: E501

        :return: The can_import of this EmployeesImportSalaryTypes.  # noqa: E501
        :rtype: bool
        """
    ...
    def can_import(self, can_import):
        """Sets the can_import of this EmployeesImportSalaryTypes.

        Whether this salary type can be imported as is (usually if salaryTypeID is missing, it cannot)  # noqa: E501

        :param can_import: The can_import of this EmployeesImportSalaryTypes.  # noqa: E501
        :type: bool
        """
    ...
    def external_type(self):
        """Gets the external_type of this EmployeesImportSalaryTypes.  # noqa: E501

        Name of type in external system  # noqa: E501

        :return: The external_type of this EmployeesImportSalaryTypes.  # noqa: E501
        :rtype: str
        """
    ...
    def external_type(self, external_type):
        """Sets the external_type of this EmployeesImportSalaryTypes.

        Name of type in external system  # noqa: E501

        :param external_type: The external_type of this EmployeesImportSalaryTypes.  # noqa: E501
        :type: str
        """
    ...
    def import_salary_type_id(self):
        """Gets the import_salary_type_id of this EmployeesImportSalaryTypes.  # noqa: E501

        Temporary ID for salary type, for the purpose of modifying it  # noqa: E501

        :return: The import_salary_type_id of this EmployeesImportSalaryTypes.  # noqa: E501
        :rtype: str
        """
    ...
    def import_salary_type_id(self, import_salary_type_id):
        """Sets the import_salary_type_id of this EmployeesImportSalaryTypes.

        Temporary ID for salary type, for the purpose of modifying it  # noqa: E501

        :param import_salary_type_id: The import_salary_type_id of this EmployeesImportSalaryTypes.  # noqa: E501
        :type: str
        """
    ...
    @property
    def rate(self):
        """Gets the rate of this EmployeesImportSalaryTypes.  # noqa: E501

        Rate is not suggested by default, but must be provided if it is to be imported.  # noqa: E501

        :return: The rate of this EmployeesImportSalaryTypes.  # noqa: E501
        :rtype: float
        """
        return self._rate
    ...
    @rate.setter
    def rate(self, rate):
        """Sets the rate of this EmployeesImportSalaryTypes.

        Rate is not suggested by default, but must be provided if it is to be imported.  # noqa: E501

        :param rate: The rate of this EmployeesImportSalaryTypes.  # noqa: E501
        :type: float
        """
    ...
    def salary_type(self):
        """Gets the salary_type of this EmployeesImportSalaryTypes.  # noqa: E501

        Name of that  # noqa: E501

        :return: The salary_type of this EmployeesImportSalaryTypes.  # noqa: E501
        :rtype: str
        """
    ...
    def salary_type(self, salary_type):
        """Sets the salary_type of this EmployeesImportSalaryTypes.

        Name of that  # noqa: E501

        :param salary_type: The salary_type of this EmployeesImportSalaryTypes.  # noqa: E501
        :type: str
        """
    ...
    def salary_type_id(self):
        """Gets the salary_type_id of this EmployeesImportSalaryTypes.  # noqa: E501

        Salary's salary type  # noqa: E501

        :return: The salary_type_id of this EmployeesImportSalaryTypes.  # noqa: E501
        :rtype: str
        """
    ...
    def salary_type_id(self, salary_type_id):
        """Sets the salary_type_id of this EmployeesImportSalaryTypes.

        Salary's salary type  # noqa: E501

        :param salary_type_id: The salary_type_id of this EmployeesImportSalaryTypes.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EmployeesImportSalaryTypes):
            return False
