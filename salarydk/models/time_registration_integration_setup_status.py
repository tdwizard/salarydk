...
class TimeRegistrationIntegrationSetupStatus(object):
    ...
    openapi_types = {
        ...
        'map_rates': 'bool',
        'next': 'str',
        'salary_types': 'list[TimeRegistrationIntegrationSetupStatusSalaryTypes]',
        'state': 'str'
    }
    ...
    def __init__(self, auth_url=None, map_rates=None, next=None, salary_types=None, state=None, local_vars_configuration=None):  # noqa: E501
        """TimeRegistrationIntegrationSetupStatus - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._auth_url = None
        self._map_rates = None
        self._next = None
    ...
    @property
    def auth_url(self):
        """Gets the auth_url of this TimeRegistrationIntegrationSetupStatus.  # noqa: E501

        Returned when an authentication from the frontend is required  # noqa: E501

        :return: The auth_url of this TimeRegistrationIntegrationSetupStatus.  # noqa: E501
        :rtype: str
        """
    ...
    def auth_url(self, auth_url):
        """Sets the auth_url of this TimeRegistrationIntegrationSetupStatus.

        Returned when an authentication from the frontend is required  # noqa: E501

        :param auth_url: The auth_url of this TimeRegistrationIntegrationSetupStatus.  # noqa: E501
        :type: str
        """
    ...
    @property
    def map_rates(self):
        """Gets the map_rates of this TimeRegistrationIntegrationSetupStatus.  # noqa: E501

        Whether mapping rates is required during the `MapSalaryTypes` step  # noqa: E501

        :return: The map_rates of this TimeRegistrationIntegrationSetupStatus.  # noqa: E501
        :rtype: bool
        """
        return self._map_rates

    @map_rates.setter
    def map_rates(self, map_rates):
        """Sets the map_rates of this TimeRegistrationIntegrationSetupStatus.

        Whether mapping rates is required during the `MapSalaryTypes` step  # noqa: E501

        :param map_rates: The map_rates of this TimeRegistrationIntegrationSetupStatus.  # noqa: E501
        :type: bool
        """

        self._map_rates = map_rates

    @property
    def next(self):
        """Gets the next of this TimeRegistrationIntegrationSetupStatus.  # noqa: E501

        Next step  # noqa: E501

        :return: The next of this TimeRegistrationIntegrationSetupStatus.  # noqa: E501
        :rtype: str
        """
        return self._next
    ...
    @next.setter
    def next(self, next):
        """Sets the next of this TimeRegistrationIntegrationSetupStatus.

        Next step  # noqa: E501

        :param next: The next of this TimeRegistrationIntegrationSetupStatus.  # noqa: E501
        :type: str
        """
        allowed_values = ["NeedKey", "NeedAuth", "MapSalaryTypes", "Done"]  # noqa: E501
    ...
    def salary_types(self):
        """Gets the salary_types of this TimeRegistrationIntegrationSetupStatus.  # noqa: E501

        Returned when salary types must be mapped  # noqa: E501

        :return: The salary_types of this TimeRegistrationIntegrationSetupStatus.  # noqa: E501
        :rtype: list[TimeRegistrationIntegrationSetupStatusSalaryTypes]
        """
        return self._salary_types

    @salary_types.setter
    def salary_types(self, salary_types):
        """Sets the salary_types of this TimeRegistrationIntegrationSetupStatus.

        Returned when salary types must be mapped  # noqa: E501

        :param salary_types: The salary_types of this TimeRegistrationIntegrationSetupStatus.  # noqa: E501
        :type: list[TimeRegistrationIntegrationSetupStatusSalaryTypes]
        """
    ...
    @property
    def state(self):
        """Gets the state of this TimeRegistrationIntegrationSetupStatus.  # noqa: E501

        The state token reference to this accounting integration set up  # noqa: E501

        :return: The state of this TimeRegistrationIntegrationSetupStatus.  # noqa: E501
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        """Sets the state of this TimeRegistrationIntegrationSetupStatus.

        The state token reference to this accounting integration set up  # noqa: E501

        :param state: The state of this TimeRegistrationIntegrationSetupStatus.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TimeRegistrationIntegrationSetupStatus):
            return False
