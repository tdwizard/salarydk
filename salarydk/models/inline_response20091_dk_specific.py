...
class InlineResponse20091DkSpecific(object):
    ...
    """
    openapi_types = {
        'vacation_type_change': 'bool'
    }

    attribute_map = {
        'vacation_type_change': 'vacationTypeChange'
    }

    def __init__(self, vacation_type_change=None, local_vars_configuration=None):  # noqa: E501
        """InlineResponse20091DkSpecific - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._vacation_type_change = None
        self.discriminator = None

        if vacation_type_change is not None:
            self.vacation_type_change = vacation_type_change

    @property
    def vacation_type_change(self):
        """Gets the vacation_type_change of this InlineResponse20091DkSpecific.  # noqa: E501

        Whether this contract changed the vacation types from the old to the new  # noqa: E501

        :return: The vacation_type_change of this InlineResponse20091DkSpecific.  # noqa: E501
        :rtype: bool
        """
        return self._vacation_type_change

    @vacation_type_change.setter
    def vacation_type_change(self, vacation_type_change):
        """Sets the vacation_type_change of this InlineResponse20091DkSpecific.

        Whether this contract changed the vacation types from the old to the new  # noqa: E501

        :param vacation_type_change: The vacation_type_change of this InlineResponse20091DkSpecific.  # noqa: E501
        :type: bool
        """

        self._vacation_type_change = vacation_type_change
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineResponse20091DkSpecific):
            return False
