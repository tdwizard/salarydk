...
class CompanyFeaturesApi(object):
    ...
    def activate_company_feature(self, feature, **kwargs):  # noqa: E501
        """activate_company_feature  # noqa: E501

        Activate feature for company, requires admin.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activate_company_feature(feature, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param InlineObject19 feature: (required)
        ...
        return self.activate_company_feature_with_http_info(feature, **kwargs)  # noqa: E501

    def activate_company_feature_with_http_info(self, feature, **kwargs):  # noqa: E501
        """activate_company_feature  # noqa: E501

        Activate feature for company, requires admin.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.activate_company_feature_with_http_info(feature, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method activate_company_feature" % key
                )
        ...
        if self.api_client.client_side_validation and ('feature' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `feature` when calling `activate_company_feature`")  # noqa: E501
        ...
        if 'feature' in local_var_params:
            body_params = local_var_params['feature']
        # HTTP header `Accept`
    ...
    def deactivate_company_feature(self, company_id, feature_type, **kwargs):  # noqa: E501
        """deactivate_company_feature  # noqa: E501

        Deactivate feature for company, requires admin.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.deactivate_company_feature(company_id, feature_type, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str company_id: (required)
        :param str feature_type: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.deactivate_company_feature_with_http_info(company_id, feature_type, **kwargs)  # noqa: E501

    def deactivate_company_feature_with_http_info(self, company_id, feature_type, **kwargs):  # noqa: E501
        """deactivate_company_feature  # noqa: E501

        Deactivate feature for company, requires admin.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.deactivate_company_feature_with_http_info(company_id, feature_type, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method deactivate_company_feature" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('company_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `company_id` when calling `deactivate_company_feature`")  # noqa: E501
        # verify the required parameter 'feature_type' is set
        if self.api_client.client_side_validation and ('feature_type' not in local_var_params or  # noqa: E501
                                                        local_var_params['feature_type'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `feature_type` when calling `deactivate_company_feature`")  # noqa: E501
        ...
        if 'feature_type' in local_var_params and local_var_params['feature_type'] is not None:  # noqa: E501
            query_params.append(('featureType', local_var_params['feature_type']))  # noqa: E501
    ...
    def get_company_features(self, company_id, **kwargs):  # noqa: E501
        """get_company_features  # noqa: E501

        Get a list of active features for a company.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_company_features(company_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_company_features_with_http_info(company_id, **kwargs)  # noqa: E501

    def get_company_features_with_http_info(self, company_id, **kwargs):  # noqa: E501
        """get_company_features  # noqa: E501

        Get a list of active features for a company.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_company_features_with_http_info(company_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_company_features" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'company_id' is set
        if self.api_client.client_side_validation and ('company_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['company_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `company_id` when calling `get_company_features`")  # noqa: E501
