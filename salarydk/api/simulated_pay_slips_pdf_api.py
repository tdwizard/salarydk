...
class SimulatedPaySlipsPDFApi(object):
    ...
    def simulate_pay_slip_pdf(self, employee_id, **kwargs):  # noqa: E501
        """simulate_pay_slip_pdf  # noqa: E501

        simulate the next payslip for an employee  Note that this endpoints takes authorization as a query parameter instead of a header. [Details](#section/Authentication/authorizedUser)   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.simulate_pay_slip_pdf(employee_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.simulate_pay_slip_pdf_with_http_info(employee_id, **kwargs)  # noqa: E501

    def simulate_pay_slip_pdf_with_http_info(self, employee_id, **kwargs):  # noqa: E501
        """simulate_pay_slip_pdf  # noqa: E501

        simulate the next payslip for an employee  Note that this endpoints takes authorization as a query parameter instead of a header. [Details](#section/Authentication/authorizedUser)   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.simulate_pay_slip_pdf_with_http_info(employee_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method simulate_pay_slip_pdf" % key
                )
        ...
        if self.api_client.client_side_validation and ('employee_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `employee_id` when calling `simulate_pay_slip_pdf`")  # noqa: E501
