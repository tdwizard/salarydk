...
class EmploymentPositionsApi(object):
    ...
    def get_employment_positions(self, **kwargs):  # noqa: E501
        """get_employment_positions  # noqa: E501

        Get a list of standard employment positions.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_employment_positions(async_req=True)
        >>> result = thread.get()
        ...
        return self.get_employment_positions_with_http_info(**kwargs)  # noqa: E501

    def get_employment_positions_with_http_info(self, **kwargs):  # noqa: E501
        """get_employment_positions  # noqa: E501

        Get a list of standard employment positions.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_employment_positions_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_employment_positions" % key
                )
