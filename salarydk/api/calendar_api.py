...
class CalendarApi(object):
    ...
    def get_calendar_for_employee(self, id, **kwargs):  # noqa: E501
        """get_calendar_for_employee  # noqa: E501

        Get ical file for employee  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_calendar_for_employee(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str id: The ID of the employee (required)
        :param str key: The access key for the calendar
        ...
        return self.get_calendar_for_employee_with_http_info(id, **kwargs)  # noqa: E501

    def get_calendar_for_employee_with_http_info(self, id, **kwargs):  # noqa: E501
        """get_calendar_for_employee  # noqa: E501

        Get ical file for employee  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_calendar_for_employee_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_calendar_for_employee" % key
                )
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `get_calendar_for_employee`")  # noqa: E501
