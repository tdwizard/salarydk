...
class TransactionsApi(object):
    ...
    def get_transaction(self, id, **kwargs):  # noqa: E501
        ...
        Get details for a transaction  # noqa: E501
    ...
    def get_transaction_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse200159, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_transactions(self, employee_id, **kwargs):  # noqa: E501
        """get_transactions  # noqa: E501

        Gets all transactions for an employee  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_transactions(employee_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_transactions_with_http_info(employee_id, **kwargs)  # noqa: E501

    def get_transactions_with_http_info(self, employee_id, **kwargs):  # noqa: E501
        """get_transactions  # noqa: E501

        Gets all transactions for an employee  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_transactions_with_http_info(employee_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse200158, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('employee_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `employee_id` when calling `get_transactions`")  # noqa: E501
