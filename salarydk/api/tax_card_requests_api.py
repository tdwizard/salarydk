...
class TaxCardRequestsApi(object):
    ...
    def create_tax_card_request(self, tax_card_request, **kwargs):  # noqa: E501
        """create_tax_card_request  # noqa: E501

        Requests an updated tax card from the authorities  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_tax_card_request(tax_card_request, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param InlineObject68 tax_card_request: (required)
        ...
        return self.create_tax_card_request_with_http_info(tax_card_request, **kwargs)  # noqa: E501

    def create_tax_card_request_with_http_info(self, tax_card_request, **kwargs):  # noqa: E501
        """create_tax_card_request  # noqa: E501

        Requests an updated tax card from the authorities  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_tax_card_request_with_http_info(tax_card_request, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse200148, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method create_tax_card_request" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'tax_card_request' is set
        if self.api_client.client_side_validation and ('tax_card_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['tax_card_request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `tax_card_request` when calling `create_tax_card_request`")  # noqa: E501
        ...
        body_params = None
        if 'tax_card_request' in local_var_params:
            body_params = local_var_params['tax_card_request']
        # HTTP header `Accept`
    ...
    def get_tax_card_requests(self, **kwargs):  # noqa: E501
        """get_tax_card_requests  # noqa: E501

        Get all tax card requests, filtered by employeeID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_tax_card_requests(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_tax_card_requests_with_http_info(**kwargs)  # noqa: E501

    def get_tax_card_requests_with_http_info(self, **kwargs):  # noqa: E501
        """get_tax_card_requests  # noqa: E501

        Get all tax card requests, filtered by employeeID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_tax_card_requests_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse200147, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_tax_card_requests" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
