...
class UserDepartmentsApi(object):
    ...
    def get_user_departments(self, company_id, **kwargs):  # noqa: E501
        """get_user_departments  # noqa: E501

        Get user department settings for specific company given the current user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_departments(company_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_user_departments_with_http_info(company_id, **kwargs)  # noqa: E501

    def get_user_departments_with_http_info(self, company_id, **kwargs):  # noqa: E501
        """get_user_departments  # noqa: E501

        Get user department settings for specific company given the current user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_departments_with_http_info(company_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse200165, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_user_departments" % key
                )
        ...
        if self.api_client.client_side_validation and ('company_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `company_id` when calling `get_user_departments`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v2/userDepartments/{companyID}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
