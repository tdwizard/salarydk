...
class StagedImportsApi(object):
    ...
    def apply_staged_import(self, id, **kwargs):  # noqa: E501
        """apply_staged_import  # noqa: E501

        Applies the staged data  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.apply_staged_import(id, async_req=True)
        >>> result = thread.get()
        ...
        return self.apply_staged_import_with_http_info(id, **kwargs)  # noqa: E501

    def apply_staged_import_with_http_info(self, id, **kwargs):  # noqa: E501
        """apply_staged_import  # noqa: E501

        Applies the staged data  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.apply_staged_import_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse200138, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method apply_staged_import" % key
                )
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `apply_staged_import`")  # noqa: E501
    ...
    def created_staged_import(self, import_data, **kwargs):  # noqa: E501
        """created_staged_import  # noqa: E501

        Stages an import from a file  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.created_staged_import(import_data, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param InlineObject64 import_data: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.created_staged_import_with_http_info(import_data, **kwargs)  # noqa: E501

    def created_staged_import_with_http_info(self, import_data, **kwargs):  # noqa: E501
        """created_staged_import  # noqa: E501

        Stages an import from a file  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.created_staged_import_with_http_info(import_data, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse200137, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method created_staged_import" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'import_data' is set
        if self.api_client.client_side_validation and ('import_data' not in local_var_params or  # noqa: E501
                                                        local_var_params['import_data'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `import_data` when calling `created_staged_import`")  # noqa: E501
        ...
        body_params = None
        if 'import_data' in local_var_params:
            body_params = local_var_params['import_data']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def import_from_other_system(self, **kwargs):  # noqa: E501
        """import_from_other_system  # noqa: E501

        Import from a traditional pay roll system  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.import_from_other_system(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param InlineObject67 importdata:
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.import_from_other_system_with_http_info(**kwargs)  # noqa: E501

    def import_from_other_system_with_http_info(self, **kwargs):  # noqa: E501
        """import_from_other_system  # noqa: E501

        Import from a traditional pay roll system  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.import_from_other_system_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method import_from_other_system" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        body_params = None
        if 'importdata' in local_var_params:
            body_params = local_var_params['importdata']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
