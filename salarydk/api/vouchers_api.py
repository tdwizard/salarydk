...
class VouchersApi(object):
    ...
    def get_accounting(self, **kwargs):  # noqa: E501
        """get_accounting  # noqa: E501

        Gets all voucher rows, filtered by payRollID or companyID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_accounting(async_req=True)
        >>> result = thread.get()
        ...
        return self.get_accounting_with_http_info(**kwargs)  # noqa: E501

    def get_accounting_with_http_info(self, **kwargs):  # noqa: E501
        """get_accounting  # noqa: E501

        Gets all voucher rows, filtered by payRollID or companyID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_accounting_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse200170, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def rebook_voucher(self, id, **kwargs):  # noqa: E501
        """rebook_voucher  # noqa: E501

        Rebooks a failed voucher. The voucher must have state = `Booking Failed`. The accounts for the voucher will be remapped with the current accounting configuration of the company, and queued for booking.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rebook_voucher(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.rebook_voucher_with_http_info(id, **kwargs)  # noqa: E501

    def rebook_voucher_with_http_info(self, id, **kwargs):  # noqa: E501
        """rebook_voucher  # noqa: E501

        Rebooks a failed voucher. The voucher must have state = `Booking Failed`. The accounts for the voucher will be remapped with the current accounting configuration of the company, and queued for booking.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rebook_voucher_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse200171, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `rebook_voucher`")  # noqa: E501
