...
class SupplementTypesApi(object):
    ...
    def get_supplement_types(self, company_id, **kwargs):  # noqa: E501
        """get_supplement_types  # noqa: E501

        Gets supplement types, filtered by companyID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_supplement_types(company_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_supplement_types_with_http_info(company_id, **kwargs)  # noqa: E501

    def get_supplement_types_with_http_info(self, company_id, **kwargs):  # noqa: E501
        """get_supplement_types  # noqa: E501

        Gets supplement types, filtered by companyID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_supplement_types_with_http_info(company_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse200142, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_supplement_types" % key
                )
        ...
        if self.api_client.client_side_validation and ('company_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `company_id` when calling `get_supplement_types`")  # noqa: E501
    ...
    def update_supplement_payout(self, company_id, supplement_type, **kwargs):  # noqa: E501
        """update_supplement_payout  # noqa: E501

        update payout on termination or expiration company-wide  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_supplement_payout(company_id, supplement_type, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str company_id: (required)
        :param InlineObject66 supplement_type: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_supplement_payout_with_http_info(company_id, supplement_type, **kwargs)  # noqa: E501

    def update_supplement_payout_with_http_info(self, company_id, supplement_type, **kwargs):  # noqa: E501
        """update_supplement_payout  # noqa: E501

        update payout on termination or expiration company-wide  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_supplement_payout_with_http_info(company_id, supplement_type, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse200143, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_supplement_payout" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'company_id' is set
        if self.api_client.client_side_validation and ('company_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['company_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `company_id` when calling `update_supplement_payout`")  # noqa: E501
        # verify the required parameter 'supplement_type' is set
        if self.api_client.client_side_validation and ('supplement_type' not in local_var_params or  # noqa: E501
                                                        local_var_params['supplement_type'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `supplement_type` when calling `update_supplement_payout`")  # noqa: E501
        ...
        body_params = None
        if 'supplement_type' in local_var_params:
            body_params = local_var_params['supplement_type']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v2/supplementTypes/{companyID}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
