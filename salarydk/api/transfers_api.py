...
class TransfersApi(object):
    ...
    def get_transfers(self, **kwargs):  # noqa: E501
        """get_transfers  # noqa: E501

        Gets all transfers, filtered by payRollID or companyID.  # noqa: E501
        ...
        :param bool include_details: For each returned transfer, include details such as which employee the transfer belongs to. Setting this to false improves performance.
        :param date _from: When listing for a company, only return transfers with a payment date later than this date.
        :param date to: When listing for a company, only return transfers with a payment date earlier than this date.
    ...
    def get_transfers_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse200160, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] > 1000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_transfers`, must be a value less than or equal to `1000`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_transfers`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        if 'include_details' in local_var_params and local_var_params['include_details'] is not None:  # noqa: E501
            query_params.append(('includeDetails', local_var_params['include_details']))  # noqa: E501
    ...
    def patch_transfer(self, id, automation, **kwargs):  # noqa: E501
        """patch_transfer  # noqa: E501

        Change the automation or date of a transfer, or try a failed transfer again  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_transfer(id, automation, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str id: (required)
        :param InlineObject75 automation: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.patch_transfer_with_http_info(id, automation, **kwargs)  # noqa: E501

    def patch_transfer_with_http_info(self, id, automation, **kwargs):  # noqa: E501
        """patch_transfer  # noqa: E501

        Change the automation or date of a transfer, or try a failed transfer again  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_transfer_with_http_info(id, automation, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse200161, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `patch_transfer`")  # noqa: E501
        # verify the required parameter 'automation' is set
        if self.api_client.client_side_validation and ('automation' not in local_var_params or  # noqa: E501
                                                        local_var_params['automation'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `automation` when calling `patch_transfer`")  # noqa: E501
        ...
        body_params = None
        if 'automation' in local_var_params:
            body_params = local_var_params['automation']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
