...
class PensionCompaniesApi(object):
    ...
    def get_pension_companies(self, **kwargs):  # noqa: E501
        """get_pension_companies  # noqa: E501

        Get all pension companies  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_pension_companies(async_req=True)
        >>> result = thread.get()
        ...
        return self.get_pension_companies_with_http_info(**kwargs)  # noqa: E501

    def get_pension_companies_with_http_info(self, **kwargs):  # noqa: E501
        """get_pension_companies  # noqa: E501

        Get all pension companies  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_pension_companies_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse200121, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_pension_companies" % key
                )
