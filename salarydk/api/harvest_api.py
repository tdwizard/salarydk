...
class HarvestApi(object):
    ...
    def harvest_information(self, harvest, **kwargs):  # noqa: E501
        """harvest_information  # noqa: E501

        Harvest information for user or company  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.harvest_information(harvest, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param list[HarvestInformation] harvest: (required)
        ...
        return self.harvest_information_with_http_info(harvest, **kwargs)  # noqa: E501

    def harvest_information_with_http_info(self, harvest, **kwargs):  # noqa: E501
        """harvest_information  # noqa: E501

        Harvest information for user or company  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.harvest_information_with_http_info(harvest, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method harvest_information" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'harvest' is set
        if self.api_client.client_side_validation and ('harvest' not in local_var_params or  # noqa: E501
                                                        local_var_params['harvest'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `harvest` when calling `harvest_information`")  # noqa: E501
        ...
        body_params = None
        if 'harvest' in local_var_params:
            body_params = local_var_params['harvest']
        # HTTP header `Accept`
    ...
    def register_user_interest(self, harvest, **kwargs):  # noqa: E501
        """register_user_interest  # noqa: E501

        Register user interest  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.register_user_interest(harvest, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param InlineObject79 harvest: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.register_user_interest_with_http_info(harvest, **kwargs)  # noqa: E501

    def register_user_interest_with_http_info(self, harvest, **kwargs):  # noqa: E501
        """register_user_interest  # noqa: E501

        Register user interest  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.register_user_interest_with_http_info(harvest, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method register_user_interest" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'harvest' is set
        if self.api_client.client_side_validation and ('harvest' not in local_var_params or  # noqa: E501
                                                        local_var_params['harvest'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `harvest` when calling `register_user_interest`")  # noqa: E501
