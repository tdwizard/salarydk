...
class LeadsApi(object):
    ...
    def create_outgoing_lead(self, lead, **kwargs):  # noqa: E501
        """create_outgoing_lead  # noqa: E501

        Create a new outgoing lead  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_outgoing_lead(lead, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param InlineObject51 lead: (required)
        ...
        return self.create_outgoing_lead_with_http_info(lead, **kwargs)  # noqa: E501

    def create_outgoing_lead_with_http_info(self, lead, **kwargs):  # noqa: E501
        """create_outgoing_lead  # noqa: E501

        Create a new outgoing lead  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_outgoing_lead_with_http_info(lead, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse200112, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method create_outgoing_lead" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'lead' is set
        if self.api_client.client_side_validation and ('lead' not in local_var_params or  # noqa: E501
                                                        local_var_params['lead'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `lead` when calling `create_outgoing_lead`")  # noqa: E501
        ...
        if 'lead' in local_var_params:
            body_params = local_var_params['lead']
        # HTTP header `Accept`
    ...
    def get_outgoing_leads(self, company_id, **kwargs):  # noqa: E501
        """get_outgoing_leads  # noqa: E501

        Gets outgoing leads  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_outgoing_leads(company_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_outgoing_leads_with_http_info(company_id, **kwargs)  # noqa: E501

    def get_outgoing_leads_with_http_info(self, company_id, **kwargs):  # noqa: E501
        """get_outgoing_leads  # noqa: E501

        Gets outgoing leads  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_outgoing_leads_with_http_info(company_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse200111, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_outgoing_leads" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('company_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `company_id` when calling `get_outgoing_leads`")  # noqa: E501
