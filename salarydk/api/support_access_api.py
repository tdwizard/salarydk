...
class SupportAccessApi(object):
    ...
    def get_support_access(self, company_id, **kwargs):  # noqa: E501
        """get_support_access  # noqa: E501

        Check if support access has been granted  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_support_access(company_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_support_access_with_http_info(company_id, **kwargs)  # noqa: E501

    def get_support_access_with_http_info(self, company_id, **kwargs):  # noqa: E501
        """get_support_access  # noqa: E501

        Check if support access has been granted  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_support_access_with_http_info(company_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse200144, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('company_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `company_id` when calling `get_support_access`")  # noqa: E501
    ...
    def grant_support_access(self, company_id, **kwargs):  # noqa: E501
        """grant_support_access  # noqa: E501

        Grant support access for 4 hours  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.grant_support_access(company_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.grant_support_access_with_http_info(company_id, **kwargs)  # noqa: E501

    def grant_support_access_with_http_info(self, company_id, **kwargs):  # noqa: E501
        """grant_support_access  # noqa: E501

        Grant support access for 4 hours  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.grant_support_access_with_http_info(company_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('company_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['company_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `company_id` when calling `grant_support_access`")  # noqa: E501
    ...
    def revoke_support_access(self, company_id, **kwargs):  # noqa: E501
        """revoke_support_access  # noqa: E501

        Revokes support access previously granted  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.revoke_support_access(company_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.revoke_support_access_with_http_info(company_id, **kwargs)  # noqa: E501

    def revoke_support_access_with_http_info(self, company_id, **kwargs):  # noqa: E501
        """revoke_support_access  # noqa: E501

        Revokes support access previously granted  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.revoke_support_access_with_http_info(company_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method revoke_support_access" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'company_id' is set
        if self.api_client.client_side_validation and ('company_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['company_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `company_id` when calling `revoke_support_access`")  # noqa: E501
