...
class CompanyBankAccountsApi(object):
    ...
    def set_company_bank_account(self, company_id, bank_account, **kwargs):  # noqa: E501
        """set_company_bank_account  # noqa: E501

        Set the company bank account for paying salary. The contact information must be a person with power of attorney. If they are blank, the contact information for the logged in user will be used instead.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_company_bank_account(company_id, bank_account, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str company_id: (required)
        :param InlineObject17 bank_account: (required)
        ...
        return self.set_company_bank_account_with_http_info(company_id, bank_account, **kwargs)  # noqa: E501

    def set_company_bank_account_with_http_info(self, company_id, bank_account, **kwargs):  # noqa: E501
        """set_company_bank_account  # noqa: E501

        Set the company bank account for paying salary. The contact information must be a person with power of attorney. If they are blank, the contact information for the logged in user will be used instead.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_company_bank_account_with_http_info(company_id, bank_account, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method set_company_bank_account" % key
                )
        ...
        if self.api_client.client_side_validation and ('company_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `company_id` when calling `set_company_bank_account`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('bank_account' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `bank_account` when calling `set_company_bank_account`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v2/companyBankAccounts/{companyID}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
