...
class RemoteUploadContentsApi(object):
    ...
    def get_remote_upload_content(self, id, **kwargs):  # noqa: E501
        """get_remote_upload_content  # noqa: E501

        Get the content of a shipment  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_remote_upload_content(id, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_remote_upload_content_with_http_info(id, **kwargs)  # noqa: E501

    def get_remote_upload_content_with_http_info(self, id, **kwargs):  # noqa: E501
        """get_remote_upload_content  # noqa: E501

        Get the content of a shipment  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_remote_upload_content_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse200127, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_remote_upload_content" % key
                )
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `get_remote_upload_content`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v2/remoteUploadContents/{id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
