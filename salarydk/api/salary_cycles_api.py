...
class SalaryCyclesApi(object):
    ...
    def get_salary_cycles(self, **kwargs):  # noqa: E501
        """List Salary Cycles  # noqa: E501

        Gets the list of salary cycles  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_salary_cycles(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param bool include_salary_periods: If true, all periods for each cycle will be returned.
        :param str company_id: If included and `includeSalaryPeriods` is true, each period will have a disposition date and a flag telling if today is early enough to run a salary for it.
        ...
        return self.get_salary_cycles_with_http_info(**kwargs)  # noqa: E501

    def get_salary_cycles_with_http_info(self, **kwargs):  # noqa: E501
        """List Salary Cycles  # noqa: E501

        Gets the list of salary cycles  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_salary_cycles_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse200129, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_salary_cycles" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']

        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] > 1000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_salary_cycles`, must be a value less than or equal to `1000`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_salary_cycles`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}

        path_params = {}

        query_params = []
        if 'include_salary_periods' in local_var_params and local_var_params['include_salary_periods'] is not None:  # noqa: E501
            query_params.append(('includeSalaryPeriods', local_var_params['include_salary_periods']))  # noqa: E501
