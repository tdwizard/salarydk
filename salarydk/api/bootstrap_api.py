...
class BootstrapApi(object):
    ...
    def get_bootstrap(self, **kwargs):  # noqa: E501
        ...
        Bootstrap the frontend with a lot of data  # noqa: E501
        ...
        :param str company_id: If provided, also return data for a company
    ...
    def get_dashboard(self, **kwargs):  # noqa: E501
        ...
        Get information for the dashboard  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool: execute request asynchronously
        :param str company_id: Limit the response to the single company given
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def set_app_version(self, version, **kwargs):  # noqa: E501
        """set_app_version  # noqa: E501

        Set the current valid version  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_app_version(version, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.set_app_version_with_http_info(version, **kwargs)  # noqa: E501

    def set_app_version_with_http_info(self, version, **kwargs):  # noqa: E501
        """set_app_version  # noqa: E501

        Set the current valid version  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_app_version_with_http_info(version, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('version' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `version` when calling `set_app_version`")  # noqa: E501
    ...
    def verify_app_version(self, version, platform, **kwargs):  # noqa: E501
        """verify_app_version  # noqa: E501

        Verify that the app version is valid  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.verify_app_version(version, platform, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.verify_app_version_with_http_info(version, platform, **kwargs)  # noqa: E501

    def verify_app_version_with_http_info(self, version, platform, **kwargs):  # noqa: E501
        """verify_app_version  # noqa: E501

        Verify that the app version is valid  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.verify_app_version_with_http_info(version, platform, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method verify_app_version" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'version' is set
        if self.api_client.client_side_validation and ('version' not in local_var_params or  # noqa: E501
                                                        local_var_params['version'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `version` when calling `verify_app_version`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('platform' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `platform` when calling `verify_app_version`")  # noqa: E501
