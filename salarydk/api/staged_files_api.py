...
class StagedFilesApi(object):
    ...
    def upload_staged_file(self, file_data, **kwargs):  # noqa: E501
        """upload_staged_file  # noqa: E501

        Upload a file to be referred in another request. The file will be removed after 5 minutes.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upload_staged_file(file_data, async_req=True)
        >>> result = thread.get()
        ...
        return self.upload_staged_file_with_http_info(file_data, **kwargs)  # noqa: E501

    def upload_staged_file_with_http_info(self, file_data, **kwargs):  # noqa: E501
        """upload_staged_file  # noqa: E501

        Upload a file to be referred in another request. The file will be removed after 5 minutes.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upload_staged_file_with_http_info(file_data, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse200136, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method upload_staged_file" % key
                )
        ...
        if self.api_client.client_side_validation and ('file_data' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `file_data` when calling `upload_staged_file`")  # noqa: E501
