...
class StartBalancesApi(object):
    ...
    def get_start_balance(self, employment_id, **kwargs):  # noqa: E501
        """get_start_balance  # noqa: E501

        Gets the registrered start balance for this employment  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_start_balance(employment_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_start_balance_with_http_info(employment_id, **kwargs)  # noqa: E501

    def get_start_balance_with_http_info(self, employment_id, **kwargs):  # noqa: E501
        """get_start_balance  # noqa: E501

        Gets the registrered start balance for this employment  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_start_balance_with_http_info(employment_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse200140, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_start_balance" % key
                )
        ...
        if self.api_client.client_side_validation and ('employment_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `employment_id` when calling `get_start_balance`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v2/startBalances/{employmentID}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_start_balance(self, employment_id, start_balance, **kwargs):  # noqa: E501
        """update_start_balance  # noqa: E501

        Updates the registrered start balance for this employment  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_start_balance(employment_id, start_balance, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str employment_id: (required)
        :param StartBalance start_balance: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_start_balance_with_http_info(employment_id, start_balance, **kwargs)  # noqa: E501

    def update_start_balance_with_http_info(self, employment_id, start_balance, **kwargs):  # noqa: E501
        """update_start_balance  # noqa: E501

        Updates the registrered start balance for this employment  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_start_balance_with_http_info(employment_id, start_balance, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_start_balance" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'employment_id' is set
        if self.api_client.client_side_validation and ('employment_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['employment_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `employment_id` when calling `update_start_balance`")  # noqa: E501
        # verify the required parameter 'start_balance' is set
        if self.api_client.client_side_validation and ('start_balance' not in local_var_params or  # noqa: E501
                                                        local_var_params['start_balance'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `start_balance` when calling `update_start_balance`")  # noqa: E501
        ...
        body_params = None
        if 'start_balance' in local_var_params:
            body_params = local_var_params['start_balance']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v2/startBalances/{employmentID}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
