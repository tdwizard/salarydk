...
class ZeroTaxReportsApi(object):
    ...
    def file_zero_tax_report(self, zero_tax_report, **kwargs):  # noqa: E501
        """file_zero_tax_report  # noqa: E501

        Perform a zero tax report for a given month  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.file_zero_tax_report(zero_tax_report, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param InlineObject84 zero_tax_report: (required)
        ...
        return self.file_zero_tax_report_with_http_info(zero_tax_report, **kwargs)  # noqa: E501

    def file_zero_tax_report_with_http_info(self, zero_tax_report, **kwargs):  # noqa: E501
        """file_zero_tax_report  # noqa: E501

        Perform a zero tax report for a given month  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.file_zero_tax_report_with_http_info(zero_tax_report, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method file_zero_tax_report" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'zero_tax_report' is set
        if self.api_client.client_side_validation and ('zero_tax_report' not in local_var_params or  # noqa: E501
                                                        local_var_params['zero_tax_report'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `zero_tax_report` when calling `file_zero_tax_report`")  # noqa: E501
        ...
        body_params = None
        if 'zero_tax_report' in local_var_params:
            body_params = local_var_params['zero_tax_report']
        # HTTP header `Accept`
