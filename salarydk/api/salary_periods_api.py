...
class SalaryPeriodsApi(object):
    ...
    def get_salary_periods(self, **kwargs):  # noqa: E501
        """List Salary Periods  # noqa: E501

        Gets the list of salary periods, filtered by cycle.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_salary_periods(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str salary_cycle_id: Required if `employeeID` not provided.
        :param str company_id: If included, each period will have a disposition date and a flag telling if today is early enough to run a salary for it.
        :param str employee_id: Ignored if `salaryCycleID` is provided.  Finds the `salaryCycleID` matching the employee's current contract.  If `date` is also provided, it will use the `salaryCycleID` for the contract that was valid on that date.
        :param date date: If included, will restrict the list of salary periods to the one that would include the given date.
        ...
        return self.get_salary_periods_with_http_info(**kwargs)  # noqa: E501

    def get_salary_periods_with_http_info(self, **kwargs):  # noqa: E501
        """List Salary Periods  # noqa: E501

        Gets the list of salary periods, filtered by cycle.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_salary_periods_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse200130, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_salary_periods" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']

        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] > 1000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_salary_periods`, must be a value less than or equal to `1000`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_salary_periods`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}

        path_params = {}

        query_params = []
        if 'salary_cycle_id' in local_var_params and local_var_params['salary_cycle_id'] is not None:  # noqa: E501
            query_params.append(('salaryCycleID', local_var_params['salary_cycle_id']))  # noqa: E501
