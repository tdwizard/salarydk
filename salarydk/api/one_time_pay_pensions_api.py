...
class OneTimePayPensionsApi(object):
    ...
    def create_one_time_pay_pension(self, one_time_pay_pension, **kwargs):  # noqa: E501
        """create_one_time_pay_pension  # noqa: E501

        Create a new one time pay pension  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_one_time_pay_pension(one_time_pay_pension, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param OneTimePayPension one_time_pay_pension: (required)
        ...
        return self.create_one_time_pay_pension_with_http_info(one_time_pay_pension, **kwargs)  # noqa: E501

    def create_one_time_pay_pension_with_http_info(self, one_time_pay_pension, **kwargs):  # noqa: E501
        """create_one_time_pay_pension  # noqa: E501

        Create a new one time pay pension  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_one_time_pay_pension_with_http_info(one_time_pay_pension, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse200108, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method create_one_time_pay_pension" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'one_time_pay_pension' is set
        if self.api_client.client_side_validation and ('one_time_pay_pension' not in local_var_params or  # noqa: E501
                                                        local_var_params['one_time_pay_pension'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `one_time_pay_pension` when calling `create_one_time_pay_pension`")  # noqa: E501
        ...
        body_params = None
        if 'one_time_pay_pension' in local_var_params:
            body_params = local_var_params['one_time_pay_pension']
        # HTTP header `Accept`
    ...
    def get_onetime_pay_pensions(self, **kwargs):  # noqa: E501
        """get_onetime_pay_pensions  # noqa: E501

        Gets all one time pay pensions, filtered by employeeId, companyID or payRollID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_onetime_pay_pensions(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_onetime_pay_pensions_with_http_info(**kwargs)  # noqa: E501

    def get_onetime_pay_pensions_with_http_info(self, **kwargs):  # noqa: E501
        """get_onetime_pay_pensions  # noqa: E501

        Gets all one time pay pensions, filtered by employeeId, companyID or payRollID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_onetime_pay_pensions_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse200107, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_onetime_pay_pensions" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
    ...
    def update_one_time_pay_pension(self, id, one_time_pay_pension, **kwargs):  # noqa: E501
        """update_one_time_pay_pension  # noqa: E501

        update the one time pay pension  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_one_time_pay_pension(id, one_time_pay_pension, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_one_time_pay_pension_with_http_info(id, one_time_pay_pension, **kwargs)  # noqa: E501

    def update_one_time_pay_pension_with_http_info(self, id, one_time_pay_pension, **kwargs):  # noqa: E501
        """update_one_time_pay_pension  # noqa: E501

        update the one time pay pension  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_one_time_pay_pension_with_http_info(id, one_time_pay_pension, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_one_time_pay_pension" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `update_one_time_pay_pension`")  # noqa: E501
        # verify the required parameter 'one_time_pay_pension' is set
        if self.api_client.client_side_validation and ('one_time_pay_pension' not in local_var_params or  # noqa: E501
                                                        local_var_params['one_time_pay_pension'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `one_time_pay_pension` when calling `update_one_time_pay_pension`")  # noqa: E501
