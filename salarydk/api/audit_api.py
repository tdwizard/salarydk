...
class AuditApi(object):
    ...
    def get_audit_log(self, **kwargs):  # noqa: E501
        """Get Audit Log  # noqa: E501

        Gets the audit log  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_audit_log(async_req=True)
        >>> result = thread.get()
        ...
        :param str company_id: Gets audit log for this company ID
        :param str user_id: Gets audit log for this user ID
        ...
        return self.get_audit_log_with_http_info(**kwargs)  # noqa: E501

    def get_audit_log_with_http_info(self, **kwargs):  # noqa: E501
        """Get Audit Log  # noqa: E501

        Gets the audit log  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_audit_log_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] > 1000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_audit_log`, must be a value less than or equal to `1000`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_audit_log`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
