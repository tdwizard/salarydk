...
class CompanyPricingsApi(object):
    ...
    def get_company_pricings(self, company_id, **kwargs):  # noqa: E501
        """get_company_pricings  # noqa: E501

        Gets a list of pricing points for a company  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_company_pricings(company_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_company_pricings_with_http_info(company_id, **kwargs)  # noqa: E501

    def get_company_pricings_with_http_info(self, company_id, **kwargs):  # noqa: E501
        """get_company_pricings  # noqa: E501

        Gets a list of pricing points for a company  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_company_pricings_with_http_info(company_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_company_pricings" % key
                )
        ...
        if self.api_client.client_side_validation and ('company_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `company_id` when calling `get_company_pricings`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v2/companyPricings/{companyID}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
