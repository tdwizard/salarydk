...
class RemoteUploadsApi(object):
    ...
    def get_remote_uploads(self, approval_status, **kwargs):  # noqa: E501
        """get_remote_uploads  # noqa: E501

        Get all remote uploads, filtered by status  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_remote_uploads(approval_status, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str approval_status: (required)
        ...
        return self.get_remote_uploads_with_http_info(approval_status, **kwargs)  # noqa: E501

    def get_remote_uploads_with_http_info(self, approval_status, **kwargs):  # noqa: E501
        """get_remote_uploads  # noqa: E501

        Get all remote uploads, filtered by status  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_remote_uploads_with_http_info(approval_status, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse200128, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_remote_uploads" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'approval_status' is set
        if self.api_client.client_side_validation and ('approval_status' not in local_var_params or  # noqa: E501
                                                        local_var_params['approval_status'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `approval_status` when calling `get_remote_uploads`")  # noqa: E501
        ...
        query_params = []
        if 'approval_status' in local_var_params and local_var_params['approval_status'] is not None:  # noqa: E501
            query_params.append(('approvalStatus', local_var_params['approval_status']))  # noqa: E501
    ...
    def patch_remote_upload(self, id, operation, **kwargs):  # noqa: E501
        """patch_remote_upload  # noqa: E501

        Alters the state of a remote upload  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_remote_upload(id, operation, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.patch_remote_upload_with_http_info(id, operation, **kwargs)  # noqa: E501

    def patch_remote_upload_with_http_info(self, id, operation, **kwargs):  # noqa: E501
        """patch_remote_upload  # noqa: E501

        Alters the state of a remote upload  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_remote_upload_with_http_info(id, operation, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_remote_upload" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `patch_remote_upload`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('operation' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `operation` when calling `patch_remote_upload`")  # noqa: E501
