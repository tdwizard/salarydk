...
class IncomeTaxReportsApi(object):
    ...
    def get_income_tax_report_file(self, pay_roll_id, **kwargs):  # noqa: E501
        """get_income_tax_report_file  # noqa: E501

        Gets income tax report file for a pay roll. The file is newly generated with new IDs.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_income_tax_report_file(pay_roll_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_income_tax_report_file_with_http_info(pay_roll_id, **kwargs)  # noqa: E501

    def get_income_tax_report_file_with_http_info(self, pay_roll_id, **kwargs):  # noqa: E501
        """get_income_tax_report_file  # noqa: E501

        Gets income tax report file for a pay roll. The file is newly generated with new IDs.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_income_tax_report_file_with_http_info(pay_roll_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_income_tax_report_file" % key
                )
        ...
        if self.api_client.client_side_validation and ('pay_roll_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `pay_roll_id` when calling `get_income_tax_report_file`")  # noqa: E501
    ...
    def get_income_tax_reports(self, pay_roll_id, **kwargs):  # noqa: E501
        """get_income_tax_reports  # noqa: E501

        Gets raw income tax report details for a pay roll.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_income_tax_reports(pay_roll_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_income_tax_reports_with_http_info(pay_roll_id, **kwargs)  # noqa: E501

    def get_income_tax_reports_with_http_info(self, pay_roll_id, **kwargs):  # noqa: E501
        """get_income_tax_reports  # noqa: E501

        Gets raw income tax report details for a pay roll.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_income_tax_reports_with_http_info(pay_roll_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InlineResponse20099, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_income_tax_reports" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'pay_roll_id' is set
        if self.api_client.client_side_validation and ('pay_roll_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['pay_roll_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `pay_roll_id` when calling `get_income_tax_reports`")  # noqa: E501
