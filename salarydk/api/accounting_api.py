...
class AccountingApi(object):
    ...
    def get_accounting_voucher_pdf(self, id, **kwargs):  # noqa: E501
        """get_accounting_voucher_pdf  # noqa: E501

        Gets an accounting voucher by id  Note that this endpoints takes authorization as a query parameter instead of a header. [Details](#section/Authentication/authorizedUser)   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_accounting_voucher_pdf(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str id: The voucher ID (required)
        ...
        return self.get_accounting_voucher_pdf_with_http_info(id, **kwargs)  # noqa: E501

    def get_accounting_voucher_pdf_with_http_info(self, id, **kwargs):  # noqa: E501
        """get_accounting_voucher_pdf  # noqa: E501

        Gets an accounting voucher by id  Note that this endpoints takes authorization as a query parameter instead of a header. [Details](#section/Authentication/authorizedUser)   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_accounting_voucher_pdf_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_accounting_voucher_pdf" % key
                )
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `get_accounting_voucher_pdf`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v2/accountingVoucherPDF/{id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
