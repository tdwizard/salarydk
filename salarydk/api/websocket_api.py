...
class WebsocketApi(object):
    ...
    def get_update_socket(self, **kwargs):  # noqa: E501
        """get_update_socket  # noqa: E501

        Websocket for getting realtime updates  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_update_socket(async_req=True)
        >>> result = thread.get()
        ...
        return self.get_update_socket_with_http_info(**kwargs)  # noqa: E501

    def get_update_socket_with_http_info(self, **kwargs):  # noqa: E501
        """get_update_socket  # noqa: E501

        Websocket for getting realtime updates  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_update_socket_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_update_socket" % key
                )
